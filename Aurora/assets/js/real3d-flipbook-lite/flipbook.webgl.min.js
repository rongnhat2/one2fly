...
((FLIPBOOK.BookWebGL = class extends FLIPBOOK.Book {
  ...
  init3d() {
    ...
    var s = this.wrapper,
      ...
      o = n.getContext("webgl2") || n.getContext("webgl");
    ...
    for (var h = !1, a = this.options.pages, r = 0; r < a.length; r++)
      a[r].htmlContent && (h = !0);
    if (
      ...
      var p = i.lightColor,
        d = new THREE.SpotLight(p);
      if (
        ((d.intensity = i.lightIntensity),
        d.position.set(i.lightPositionX, i.lightPositionY, i.lightPositionZ),
        (d.distance = 4e3),
        this.options.shadows)
      ) {
        ((d.castShadow = !0),
          (d.shadow.bias = -2e-6),
          (d.shadow.mapSize.width = this.options.shadowMapSize),
          (d.shadow.mapSize.height = this.options.shadowMapSize),
          (d.shadow.radius = 2),
          (d.angle = 0.25 * Math.PI));
        var l = new THREE.ShadowMaterial();
        ((l.opacity = this.options.shadowOpacity),
          (this.shadowPlane = new THREE.Mesh(
            new THREE.PlaneGeometry(3e3, 3e3, 1, 1),
            l,
          )),
  ...
  updatePixelRatio() {
    ...
    e !== this.pixelRatio &&
      (this.renderer.setPixelRatio(e), (this.pixelRatio = e));
  }
  onPageUnloaded(t) {
    var e,
      i = Math.floor(t / 2);
  ...
  correctZOrder() {
    const t = 0.5 * Math.PI,
      ...
      o = this.shadowPlane;
    ((this._basePowTh =
      1 === this._basePowTh || this._lastTh !== n
        ? e(n, 0.85)
        : this._basePowTh),
      (this._lastTh = n));
    const h = (this._zLeft ||= []),
    ...
    if (this.isZoomed())
      ...
      if (
        ...
        if (("cancel" == e || "end" == e) && o <= 1) {
          ...
          if (
            ((i = (180 * i) / this.wrapperW),
            (h && h.flipping) || (a && a.flipping))
          )
            return;
          i > 0 && this.canFlipPrev()
            ? (h &&
                (h._setAngle(180 - i), (h.dragging = !0), this.main.dragPage()),
  ...
  onResize(t) {
    ...
    var r = i / (s - 2 * e.bookVerticalPadding),
      ...
      l = Number(n.zoomMin);
    (n.responsiveView &&
    i <= n.responsiveViewTreshold &&
    r < 2 * p &&
    r < n.responsiveViewRatio
  ...
  updateCameraPosition() {
    ...
    (this.options.scaleCover
      ? this.centerContainer.scale.set(n / this.bookWidth, n, n)
      : this.centerContainer.scale.set(n, n, n),
  ...
  createPages() {
    var t,
      ...
      n = s.options,
      o = n,
      h = n.pageMiddleShadowSize,
      a = document.createElement("canvas");
    window;
    ((a.width = 64), (a.height = 64));
    var r = a.getContext("2d"),
      p = r.createLinearGradient(64 - h, 0, 64, 0);
    (p.addColorStop(0, "#AAAAAA"),
      p.addColorStop(1, n.pageMiddleShadowColorL),
      (r.fillStyle = p),
    ...
    (c.addColorStop(0, n.pageMiddleShadowColorR),
      c.addColorStop(1, "#AAAAAA"),
      (g.fillStyle = c),
      g.fillRect(0, 0, 64, 64));
    var u = new THREE.CanvasTexture(l);
    o.z = ("string" == typeof o.s && o.s) || "";
    const { z: f } = o;
    var m, M;
    ...
    for (!s.options.cover && P && (b += 1), i = 0; i < b; i++)
      ((t =
        0 == i || i == b - 1
          ? s.options.coverHardness
          : s.options.pageHardness),
        (e = new FLIPBOOK.PageWebGL(s, i, t, s.options, m, M)),
        s.pages.push(e),
        s.centerContainer.add(e.container),
        s.flippedright++);
    (this.correctZOrder(),
      this.bg && (this.bg.position.z = -b * y - 5),
      (s.initialized = !0));
  }
  getNumPages() {
  ...
  goToPage(t, e, i) {
    ...
    if (this.initialized) {
      if (!e || !this.isFlipping()) {
        ...
        var o = this.rightIndex > t ? this.rightIndex - 2 : this.rightIndex,
          h = this.pages[o / 2].pageHardness,
          a =
  ...
  async loadPages() {
    ...
    if (i.wrapperH && i.zoom && !this.isFlipping()) {
      var s = this.pages[this.flippedleft],
        ...
        o = this.updateHtmlLayer,
        h = this.loadMorePages;
      (e.forEach((e) => {
        ((e !== s && e !== n) || e.showMat(),
          n &&
            e.index < n.index - 2 &&
            (e.hideMat(), t.options.pdfMode || e.disposeMat()),
          s &&
            e.index > s.index + 2 &&
            (e.hideMat(), t.options.pdfMode || e.disposeMat()));
      }),
        i.setLoadingProgress(0.1),
        await this.loadPageAsync(n, "back"),
        this.pageLoaded(n, "back"),
        await this.loadPageAsync(s, "front"),
        this.pageLoaded(s, "front"),
        i.setLoadingProgress(1),
        await this.loadHTMLAsync(n, "back"),
  ...
  unloadPages() {
    ...
    this.pages.forEach(function (s) {
      (t &&
        Math.abs(s.index - t.index) > i &&
        (s.unload("front"), s.unload("back")),
        e &&
          Math.abs(s.index - e.index) > i &&
          (s.unload("front"), s.unload("back")));
    });
  }
  loadPageImage(t, e, i) {}
  ...
  moveToPos(t, e, i, s) {
    if (e && this.movingTo != t && this.centerContainer.position.x != t.x) {
      ...
      var o = this.centerContainer.position.x,
        ...
        a = t.x,
        r = t.y,
        p = { start: this.bookWidth, end: t.bookWidth };
      ((this.bookMoveTween = FLIPBOOK.animate({
        ...
        step: (t) => {
          (p.start != p.end &&
            ((this.bookWidth = p.start + (p.end - p.start) * t),
            this.onResize(!0)),
            (this.centerContainer.position.x =
              o + (a * this.centerContainer.scale.x - o) * t),
            (this.centerContainer.position.y =
              h + (r * this.centerContainer.scale.x - h) * t),
            n.updateHtmlLayerPosition());
        },
        complete: () => {
          ((n.movingTo = null), n.updateHtmlLayerPosition(), s && s.call(n));
        },
      })),
  ...
  updateHtmlLayer(t) {
    if (this.htmlLayer) {
      for (var e = 0; e < this.pages.length; e++)
        if (this.pages[e].flipping) return;
      if (t || this.htmlContentRightIndex != this.rightIndex) {
        ...
        (s && (o = s.indexF),
          ...
          this.options.doublePage
            ? 0 == this.rightIndex
              ? (o > -1 && (i = this.options.pages[o].htmlContent),
                i &&
            ...
            : (0 != this.rightIndex &&
                (h > -1 && (i = this.options.pages[h].htmlContent),
                i &&
                  (this._addHTMLContent(
                    this.options.pages[h].htmlContent,
                    this.pageLInner,
                  ),
                  this._showHTMLPage(this.pageL),
                  (this.htmlLayerVisible = !0))),
              this.rightIndex != 2 * this.pages.length &&
                ...
                i &&
                  (this._addHTMLContent(
                    this.options.pages[o].htmlContent,
                    this.pageRInner,
                  ),
                  this._showHTMLPage(this.pageR),
                  (this.htmlLayerVisible = !0)))),
  ...
  zoomTo(t, e, i, s) {
    if (!this.zooming && this.pages.length) {
      void 0 === e && (e = 0);
      var n = this.centerContainer.position;
      if (void 0 !== i && void 0 !== s) {
        ...
        (((n = r).x = r.x - (p.x - d.x)), (n.y = r.y - (p.y - d.y)));
      }
      var l = this;
      if (
        (o = t < this.options.zoomMin ? this.options.zoomMin : t) ==
        this.options.zoom
      ) {
      ...
      if ((e = 0) > 0) {
        ...
        ((this.zoom = o),
          this.centerContainer.position.set(n.x, n.y, 0),
          this.updateHtmlLayerPosition(),
          this.updateCameraPosition(),
          (this.zooming = !1));
      (t <= 1 && t <= this.zoom && this.updateBookPosition(),
        this.options.main.onZoom(o),
        this.loadPages());
    }
  }
  tiltTo(t) {
  ...
  (FLIPBOOK.PageWebGL = class {
    constructor(t, e, i, s, n, o) {
      ...
      (a && p && (c > 0 && c--, g++),
        ...
        (this.indexB = c),
        (this.showing = !1),
        (this.preloaderMatF = n),
        (this.preloaderMatB = o),
        (this.preloaderMatF = n),
        (this.preloaderMatB = o),
      ...
      var f,
        ...
        M = [m, m, m, m, n, o];
      ((f = [m, m, m, m, m, m]),
        this.options.pagePreloader && (f = [m, m, m, m, n, o]),
    ...
    load(t, e, i, s) {
      var n = this.book.main;
      if (!n.wrapperH) return;
      if (!n.zoom) return;
      var o = this;
      this.disposed = !1;
      ...
      if ("front" == t) {
        ...
        this.sizeFront == e
          ? i && i.call(this)
          : n.loadPage(this.indexF, e, function (s) {
              if (o.disposed) return;
              if (!s || a) return void (i && i.call(o));
              if (o.sizeFront == e) return void (i && i.call(o));
              o.sizeFront = e;
              const n = h.pages[o.indexF].side,
                r = o.createTexture(s, e, n),
                p = o.createMaterial(r, t);
              ((o.materials = o.materials || {}),
                (o.materials[t] = o.materials[t] || {}),
                (o.materials[t][e] = p),
                i && i.call(o));
            });
      } else if ("back" == t) {
        ...
        this.sizeBack == e
          ? i && i.call(this)
          : n.loadPage(this.indexB, e, function (s) {
              if (o.disposed) return;
              if (!s || a) return void (i && i.call(o));
              if (o.sizeBack == e) return void (i && i.call(o));
              o.sizeBack = e;
              const n = h.pages[o.indexB].side,
                r = o.createTexture(s, e, n),
                p = o.createMaterial(r, t);
              ((o.materials = o.materials || {}),
                (o.materials[t] = o.materials[t] || {}),
    ...
    loaded(t) {
      ...
      this.materials &&
        this.materials[t] &&
        this.setMat(this.materials[t][e], t);
    }
    createTexture(t, e, i) {
      let s;
      if (t.imageBitmap) {
      ...
      return (
        "left" == i
          ? (s.repeat.x = 0.5)
          : "right" == i && ((s.repeat.x = 0.5), (s.offset.x = 0.5)),
    ...
    unload(t) {
      var e, i;
      (this._sidePromises &&
        this._sidePromises[t] &&
        delete this._sidePromises[t],
    ...
    createMaterial(t, e) {
      ...
      if (this.options.lights) {
        ...
        i = new THREE.MeshStandardMaterial({
          map: t,
          roughness: n.pageRoughness,
          metalness: n.pageMetalness,
          emissive: 0,
          color: 16777215,
          lightMap: s,
        });
    ...
    _setAngle(t) {
      if (t <= 180 && t >= -180) {
        if (((t = (t / 180) * Math.PI) < 0 && (t += Math.PI), this.angle == t))
          return;
        ((this.angle = t),
    ...
    setMat(t, e) {
      const i = "front" == e ? 4 : 5;
      this.cube.material[i] !== t &&
        ((this.cube.material[i] = t), (this.book.needsUpdate = !0));
    }
    flipRightInstant(t) {
      ((this.onComplete = t),
        (this.dragging = !1),
    ...
    bendIn(t) {
      var e =
        ...
        this.duration *
        240 *
        Math.pow(Math.abs(this.container.rotation.y - t) / Math.PI, 0.5);
      ((e *= Math.pow(this.pageHardness, 0.25)),
      ...
      (this.animations.push(n), this.options.main.turnPageStart());
    }
    bendOut() {
...
(!(function (t) {
    ...
    ((t.Vector3 = function (t, e, i) {
      ...
      (t.Vector3.prototype.cross = function (e, i) {
        var s = e.x,
          ...
          a = i.y,
          r = i.z;
        return new t.Vector3(n * r - o * a, o * h - s * r, s * a - n * h);
      }),
  ...
  (function (t) {
    ((t.Matrix4 = function (t, e, i, s, n, o, h, a, r, p, d, l, g, c, u, f) {
      ((this.n11 = 1),
      ...
      (t.Matrix4.prototype.calculateMultiply = function (t, e) {
        var i = t.n11,
          ...
          w = t.n34,
          L = e.n34;
        ((this.n11 = i * s + r * o + u * a),
          (this.n12 = i * p + r * l + u * c),
          (this.n13 = i * f + r * M + u * y),
          (this.n14 = i * P + r * C + u * L + v),
          (this.n21 = n * s + d * o + m * a),
          (this.n22 = n * p + d * l + m * c),
          (this.n23 = n * f + d * M + m * y),
          (this.n24 = n * P + d * C + m * L + b),
          (this.n31 = h * s + g * o + x * a),
      ...
      (t.Matrix4.prototype.multiplyVector = function (t, e) {
        var i = e.x,
          s = e.y,
          n = e.z;
        ((e.x = i * t.n11 + s * t.n12 + n * t.n13 + t.n14),
          (e.y = i * t.n21 + s * t.n22 + n * t.n23 + t.n24),
          (e.z = i * t.n31 + s * t.n32 + n * t.n33 + t.n34));
      }));
  })(MOD3),
  (function (t) {
        ...
        if (0 != this.force)
          for (
            ...
            ((e = (a = o[h]).getValue(d)),
              ...
              (i = i.y),
              (n = (e - p) * x),
              (this.constraint == t.ModConstant.LEFT && n <= r) ||
                (this.constraint == t.ModConstant.RIGHT && n >= r) ||
                ((e = v((n = y - M * r + M * n)) * (m + s)),
                (n = P(n) * (m + s)),
                (s = e - m),
                (e = f - n)),
  ...
  (function (t) {
    ((t.MeshThree = function () {}),
      ...
      (t.MeshThree.prototype.setMesh = function (e) {
        ...
        var i,
          s = 0,
          n = this.mesh.geometry.vertices,
          o = n.length,
          h = this.mesh.geometry.faces,
          a = h.length;
        for (s = 0; s < o; )
          ((i = new t.VertexThree(this.mesh)).setVertex(n[s]),
        ...
        for (s = 0; s < a; )
          ((o = new t.FaceProxy()),
            h[s] instanceof THREE.Face3
              ? (o.addVertex(e[n[h[s].a]]),
                o.addVertex(e[n[h[s].b]]),
                o.addVertex(e[n[h[s].c]]))
              : h[s] instanceof THREE.Face4 &&
                (o.addVertex(e[n[h[s].a]]),
                o.addVertex(e[n[h[s].b]]),
                o.addVertex(e[n[h[s].c]]),
                o.addVertex(e[n[h[s].d]])),
            this.faces.push(o),
            s++);
      }),
  ...
  (FLIPBOOK.CSS3DRenderer = function () {
    ...
    function g(t, e) {
      var n = t.elements,
        o =
          ...
          ")";
      return p
        ? "translate(-50%,-50%)translate(" + i + "px," + s + "px)" + e + o
        : "translate(-50%,-50%)" + o;
    }
    function c(t, e, i, s) {
      if (t instanceof FLIPBOOK.CSS3DObject) {
        var a;
        (t.onBeforeRender(n, e, i),
          t instanceof FLIPBOOK.CSS3DSprite
            ? (o.copy(i.matrixWorldInverse),
              o.transpose(),
              o.copyPosition(t.matrixWorld),
              o.scale(t.scale),
              (o.elements[3] = 0),
              (o.elements[7] = 0),
              (o.elements[11] = 0),
        ...
        (d.parentNode !== r && r.appendChild(d), t.onAfterRender(n, e, i));
      }
      for (var f = 0, M = t.children.length; f < M; f++)
        c(t.children[f], e, i, s);
    }
    ...
    function M(t) {
      for (
        var e = (function (t) {
            ...
            return (
              h.objects.get(t).distanceToCameraSquared -
              h.objects.get(e).distanceToCameraSquared
            );
          }),
          i = e.length,
          s = 0,
    ...
    this.render = function (t, e) {
      var n = e.projectionMatrix.elements[5] * s;
      if (
        (h.camera.fov !== n &&
          (e.isPerspectiveCamera
            ? ((a.style.WebkitPerspective = n + "px"),
              (a.style.perspective = n + "px"))
      ...
      var u = e.isOrthographicCamera
          ...
          : "translateZ(" + n + "px)" + l(e.matrixWorldInverse),
        f = u + "translate(" + i + "px," + s + "px)";
      (h.camera.style === f ||
        p ||
        ((r.style.WebkitTransform = f),
        (r.style.transform = f),
        (h.camera.style = f)),
        c(t, t, e, u),
        p && M(t));
