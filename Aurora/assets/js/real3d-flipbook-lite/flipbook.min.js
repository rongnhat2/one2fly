...
((FLIPBOOK.version = "4.10.4"),
  (function (e, t, i) {
    ("undefined" != typeof jQuery &&
      ((jQuery.fn.flipBook = function (e) {
        return new FLIPBOOK.Main(e, this);
      }),
      (jQuery.fn.swipeBook = function (e) {
        return ((e.viewMode = "swipe"), new FLIPBOOK.Main(e, this));
      })),
      (e.FlipBook = function (e, t) {
        return new FLIPBOOK.Main(t, e);
      }));
  })(window, document),
  (FLIPBOOK.Main = class {
    ...
    constructor(e, t) {
      (t.length
        ? ((this.elem = t[0]), (this.elements = Array.from(t)))
        : ((this.elem = t), (this.elements = [t])),
      ...
      (e.skin && o[e.skin] && (e = FLIPBOOK.extend(!0, {}, e, o[e.skin])),
        e.layout &&
          i[e.layout] &&
          (e = FLIPBOOK.extend(!0, {}, e, i[e.layout])),
        (this.options = FLIPBOOK.extend(
          !0,
          {},
        ...
        this.options.isMobile &&
          FLIPBOOK.extend(!0, this.options, this.options.mobile),
        this.initOptions(this.options));
    }
    initOptions(e) {
      const t = this;
      ((this.strings = e.strings),
        (e.pageShininess = e.pageShininess / 2),
        (this.s = 0),
        e.isMobile &&
          ((e.singlePageMode = !!e.singlePageModeIfMobile || e.singlePageMode),
          e.viewModeMobile && (e.viewMode = e.viewModeMobile),
          e.pageTextureSizeMobile &&
            (e.pageTextureSize = e.pageTextureSizeMobile),
          e.pageTextureSizeMobileSmall &&
            (e.pageTextureSizeSmall = e.pageTextureSizeMobileSmall)));
      var i = { a: 5, b: 7, c: 2 };
      if (
        ((e.pageTextureSize = Math.pow(i.a * i.b + i.c, i.c)),
        (e.pageTextureSizeSmall = Math.pow(i.a * i.b + i.c, i.c)),
        (e.zoomSize = Math.pow(i.b * i.a + i.c, i.c)),
        "3dSinglePage" == e.viewMode && (e.singlePageMode = !0),
        "2dSinglePage" == e.viewMode &&
          ((e.singlePageMode = !0), (e.viewMode = "2d")),
        e.singlePageMode &&
          ("2d" != e.viewMode && "swipe" != e.viewMode && (e.viewMode = "3d"),
          e.rightToLeft && (e.viewMode = "swipe"),
          (e.cover = !0)),
        e.singlePageMode && "3d" == e.viewMode && (e.rightToLeft = !1),
        "simple" == e.viewMode && ((e.viewMode = "3d"), (e.instantFlip = !0)),
        e.cover || (e.responsiveView = !1),
        e.webgl)
      ) {
        i = { a: 5, b: 6, c: 2 };
        ((e.pageTextureSize = Math.pow(i.a * i.b - i.c, i.c)),
          (e.pageTextureSizeSmall = Math.pow(i.a * i.b - i.c, i.c)),
          (e.zoomSize = Math.pow(i.b * i.a + i.a, i.c)));
      }
      (Object.assign(e, {
        e: "toString",
        f: "padStart",
        ...
        (e.sideMenuPosition = e.rightToLeft ? "right" : "left"),
        "webgl" == e.viewMode && (this.hasWebGl || (e.viewMode = "3d")),
        ("webgl" == e.viewMode ||
          "scroll" == e.viewMode ||
          "swipe" == e.viewMode ||
          e.rightToLeft) &&
          (e.btnSingle.enabled = !1),
        (this.webgl = "webgl" == e.viewMode),
        e.menuFloating && (e.sideMenuOverMenu = !0),
        e.menu2Floating && ((e.menu2OverBook = !0), (e.sideMenuOverMenu2 = !0)),
        e.menuTransparent &&
          ((e.sideMenuOverMenu = !0), (e.menuBackground = "none")),
        e.menu2Transparent
          ? ((e.menu2OverBook = !0),
            (e.sideMenuOverMenu2 = !0),
            (e.menu2Background = "none"))
          : (e.sideMenuOverMenu2 = !1),
        e.menuOverBook && (e.sideMenuOverMenu = !0),
        e.menu2OverBook && (e.sideMenuOverMenu2 = !0),
        (e.pdfMode = Boolean(e.pdfUrl || e.pdfBase64)),
        e.backgroundTransparent && (e.backgroundColor = "none"),
        (this.options.containerRatio = (function (e) {
          if (void 0 !== e) {
            if ("number" == typeof e) return e;
            if ((e = String(e).trim().replace("/", ":")).includes(":")) {
              const t = e.split(":");
      ...
      let o = {};
      if (
        (e.skinColor && (o.color = e.skinColor),
        e.skinBackground && (o.bg = e.skinBackground),
        e.skin &&
          Object.assign(
            o,
            {
        ...
        this.wrapper.style.setProperty(
          "--flipbook-accent-color",
          e.accentColor,
        ),
        (this.tooltip2 = new FLIPBOOK.Tooltip2(this.wrapper)),
        "" !== e.backgroundColor &&
          (this.wrapper.style.background = e.backgroundColor),
        "" !== e.backgroundPattern &&
          (this.wrapper.style.background = `url(${e.backgroundPattern}) repeat`),
        "" !== e.backgroundImage &&
          ((this.wrapper.style.background = `url(${e.backgroundImage}) no-repeat`),
        ...
        e.pageDragDisabled && (this.bookLayer.style.cursor = "auto"),
        "spotlight" === e.linkTarget &&
          this.bookLayer.addEventListener("click", (e) => {
            "a" === e.target.tagName.toLowerCase() &&
              (e.preventDefault(), this.spotlight(e.target.href));
          }),
        e.rightClickEnabled ||
        ...
        e.hideMenu &&
          ((this.bookLayer.style.bottom = "0"), (e.menuOverBook = !0)),
        (e.pagesOriginal = JSON.parse(JSON.stringify(e.pages))),
        (this.book = document.createElement("div")),
        this.book.classList.add("book"),
        this.bookLayer.appendChild(this.book),
        e.preloader && "undefined" != typeof jQuery)
      )
        this.preloader = jQuery(e.preloader);
      else {
        ((this.preloader = document.createElement("div")),
          this.preloader.classList.add(
            "flipbook-preloader",
            "cssload-container",
          ));
        var s = document.createElement("div");
        (s.classList.add("cssload-speeding-wheel"),
          this.preloader.appendChild(s));
        var n = document.createElement("div");
        (n.classList.add("flipbook-loading-text"),
          (n.textContent = e.preloaderText),
      ...
      (this.setLoadingProgress(0),
        ...
        this.on("textlayerrendered", function (e) {
          t.searchingString && t.mark(t.searchingString);
        }),
        this.on("showpagehtml", function () {
          (this.deselectText(), t.searchingString && t.mark(t.searchingString));
        }),
        (this.addPageNotes = function (e) {
          this.noteService && this.noteService.initPageNotes(e);
        }),
        this.on("pdfinit", async function () {
          ((e.tableOfContent = t.pdfService.outline || e.tableOfContent),
            (e.doublePage = t.pdfService.double),
            e.scaleCover && ((e.doublePage = !0), (e.responsiveView = !1)),
            (e.backCover = t.pdfService.backCover),
            (t.viewportOriginal = t.pdfService.viewports[0]),
            (e.firstPage = {
              width: t.pdfService.viewports[0].width,
              height: t.pdfService.viewports[0].height,
              ratio:
                t.pdfService.viewports[0].width /
                t.pdfService.viewports[0].height,
            }),
            t.pdfService.numPages > 1 &&
              (e.secondPage = {
                width: t.pdfService.viewports[1].width,
                height: t.pdfService.viewports[1].height,
                ratio:
                  t.pdfService.viewports[1].width /
                  t.pdfService.viewports[1].height,
              }),
            (e.numPages = t.pdfService.numPages),
            e.previewPages &&
              e.numPages > e.previewPages &&
              ((e.numPages = e.previewPages),
              e.doublePage &&
                ((e.backCover = !1),
                (e.numPages = Math.ceil(e.numPages / 2)))));
          for (var i = [], o = e.pageTextureSize, s = 0; s < e.numPages; s++) {
            var n = { canvas: {} };
            (e.pages && e.pages[s] && FLIPBOOK.extend(n, e.pages[s]),
              (i[s] = n));
          }
          ((e.pages = i),
            (e.pageWidth = parseInt(
              (o * t.viewportOriginal.width) / t.viewportOriginal.height,
            )),
            (e.pageHeight = o),
            (e.pw = e.pageWidth),
            (e.ph = e.pageHeight));
          var a = e.tableOfContent;
          if (e.btnToc.enabled && (!a || !a.length)) {
            var r = await t.pdfService.loadOutline();
            r ? (e.tableOfContent = r) : (e.btnToc.enabled = !1);
          }
          ((e.doublePage || e.numPages % 2 == 1) && (e.cover = !0), t.start());
        }),
      ...
      if (
        ...
        !e.deeplinkingPrefix &&
          e.deeplinking &&
          e.deeplinking.prefix &&
          (e.deeplinkingPrefix = e.deeplinking.prefix),
        (e.deeplinkingEnabled =
          e.deeplinkingPrefix ||
          e.deeplinkingEnabled ||
          (e.deeplinking && e.deeplinking.enabled)),
        e.deeplinkingEnabled &&
          (this.checkHash(),
          window.addEventListener("hashchange", this.checkHash.bind(this))),
        (e.l = ["load", "front", "rgb", "length"]),
        e.lightBox)
      )
        ((e.btnClose.enabled = !0),
          this.canFullscreen() || (this.options.btnExpand.enabled = !1),
          (this.lightbox = new FLIPBOOK.Lightbox(this, this.wrapper, e)),
          ...
          this.elements.forEach(function (i) {
            ((i.style.cursor = "pointer"),
              i.addEventListener("click", async function (i) {
                t.disposed ||
                  (i.preventDefault(),
                  (t.lightboxStartPage = this.dataset.page),
                  t.started
                    ? (await t.lightboxStart(),
                      e.lightBoxFullscreen &&
                        setTimeout(async function () {
                          t.toggleExpand();
                        }, 0),
                      t.lightbox.openLightbox())
                    : (t.init(),
                      t.lightbox.openLightbox(),
                      e.lightBoxFullscreen &&
                        setTimeout(async function () {
          ...
          e.lightBoxOpened
            ...
            : e.lightboxPreload &&
              (async function () {
                (e.pdfMode &&
                  (await t.loadScript(FLIPBOOK.pdfjsSrc, "pdfjsLib"),
                  await t.loadScript(
                  ...
                  (e.btnSearch.enabled ||
                    e.btnNotes.enabled ||
                    e.search.enabled) &&
                    (await t.loadScript(FLIPBOOK.markSrc, "Mark"))),
                  "webgl" == e.viewMode
                    ? await t.loadScript(FLIPBOOK.threejsSrc, "THREE")
                    : await t.loadScript(FLIPBOOK.iscrollSrc, "IScroll"));
              })(),
          (this.fullscreenElement = document.body));
      else {
        ((e.btnClose.enabled = !1),
    ...
    async start() {
      ...
      if (
        (1 == e.pages.length &&
          ...
          (e.btnNext.enabled = !1),
          (e.btnPrev.enabled = !1),
          (e.btnFirst.enabled = !1),
          (e.btnLast.enabled = !1),
          (e.sideNavigationButtons = !1),
          (e.btnAutoplay.enabled = !1),
          (e.singlePageMode = !0),
          (e.viewMode = "3d"),
          (e.rightToLeft = !1),
          (e.btnThumbs.enabled = !1),
          (e.btnToc.enabled = !1),
          (e.btnBookmark.enabled = !1)),
        e.dp && (e.doublePage = !0),
        this.started)
      )
        return;
      const t = this.options.pageWidth / this.options.pageHeight;
      (t > 1 &&
        ((this.options.pageTextureSize /= t),
        (this.options.pageTextureSizeSmall /= t),
        (this.options.pageWidth /= t),
        (this.options.pageHeight /= t)),
        (this.options.zoomSize =
          this.options.zoomSize || this.options.pageTextureSize),
      ...
      this.options.pages.hasHtmlContent =
        !!this.options.pages && this.options.pages.some((e) => !!e.htmlContent);
      ...
      (i &&
        !a &&
        this.options.pages.forEach(function (e, t) {
          ((e.htmlContent = e.htmlContent || ""),
            n
              ? (t > 0 && (d ? p(e) : u(e)), t < o - 1 && (d ? u(e) : p(e)))
              : s
                ? (c.options.cover && 0 == t) ||
                  (c.options.backCover && t == c.options.pages.length - 1)
                  ? d
                    ? p(e)
                    : u(e)
                  : (p(e), u(e, !0))
    ...
    async checkHash() {
      ...
      (i < 1
        ? (i = 1)
        : this.numPages && i > this.numPages && (i = this.numPages),
        i &&
          (this.started
            ? this.Book &&
              (this.lightbox &&
                ...
                (this.lightbox.openLightbox(), await this.lightboxStart()),
              this.goToPage(i, -1 == t.indexOf("flip")))
            : ((e.startPage = o),
              e.lightBox &&
                (this.init(),
                e.lightBoxFullscreen &&
    ...
    async init() {
      ...
      const e = this.options,
        t = (e) =>
          new Promise((t, i) => {
            const o = new Image();
            ((o.src = e), (o.onload = () => t(o)), (o.onerror = i));
          });
      if (e.fillPreloader.enabled) {
        const i = document.createElement("div");
        i.classList.add("flipbook-fillPreloader");
        try {
          const o = await t(e.fillPreloader.imgEmpty),
            s = await t(e.fillPreloader.imgFull);
          (i.appendChild(o),
            i.appendChild(s),
          ...
          console.error("Error loading preloader images", e);
        }
      }
      this.initialized ||
        ...
        this.addPageItems(),
        e.pageCaptions && this.addPageCaptions(),
        e.pdfMode ? this.initPdf() : this.initJpg(),
      ...
      (this.started || (await this.start()), void 0 !== this.Book)
        ? (this.Book.enable(),
          ...
          window.location.hash ||
            (e = this.lightboxStartPage || this.options.lightboxStartPage),
          e && this.goToPage(e, !0))
        : setTimeout(function () {
            t.lightboxStart();
          }, 100);
    ...
    setHash(e) {
      (e < 1 && (e = 1),
        "#" + this.options.deeplinkingPrefix + e != window.location.hash &&
    ...
    historyStateChange(e) {
      ((this.historyStateChanges = this.historyStateChanges || 0),
        void 0 !== e
          ? (this.historyStateChanges = e)
          : this.historyStateChanges++);
    }
    clearHash() {}
    getPageFromHash() {}
    async sendGAEvent(e) {}
    lightboxEnd() {
      (document.fullscreenElement &&
        (this.toggleExpand(), this.toggleIcon(this.btnExpand, !0)),
        this.Book &&
          (this.options.lightboxStartPage &&
            this.Book.goToPage(this.options.lightboxStartPage, !0),
      ...
      (this.mediaElements &&
        this.mediaElements.forEach((e) => {
          if (
            ...
            if (
              (t.includes("youtube.com/embed") ||
                t.includes("youtube-nocookie.com/embed")) &&
              e.contentWindow
            )
              try {
        ...
        this.youtubes &&
          this.youtubes.forEach((e) => {
            const t = e.player;
            t &&
              "function" == typeof t.getCurrentTime &&
              ((e.dataset.ytCurrentTime = t.getCurrentTime()),
              (e.dataset.ytMuted = t.isMuted()),
              t.pauseVideo());
          }));
    }
    turnPageStart() {
    ...
    updateCurrentPage() {
      ...
      (s % 2 == 1 && s++, t && (s = 2 * this.Book.numSheets - s));
      ...
      if (
        ...
        1 == this.Book.view
          ...
          : (n > i || (n == i && i % 2 == 0)
              ...
              : n < 1
                ? ((e = 1), (this.cPage = [0]))
                : ((e = String(n) + "-" + String(n + 1)),
                  (this.cPage = [n - 1, n])),
            this.setHash(n)),
        this.enableNext(this.Book.canFlipNext()),
        this.enablePrev(this.Book.canFlipPrev()),
        2 === this.cPage.length
          ? (this.wrapper.querySelectorAll(".c-l-p").forEach(function (e) {
              e.classList.remove("flipbook-hidden");
            }),
            this.wrapper.querySelectorAll(".c-r-p").forEach(function (e) {
              e.classList.remove("flipbook-hidden");
            }),
            this.wrapper.querySelectorAll(".c-p").forEach(function (e) {
        ...
        (a &&
          ...
          (e = a && r ? a + "-" + r : a || r || 1),
          (this.currentPageString = e),
          this.currentPageInput.dispatchEvent(
            new Event("blur", { bubbles: !0, cancelable: !0 }),
          ),
        ...
        if (
          ...
          (t.className = "flipbook-currentPageInput"),
          document.body.appendChild(t),
          (t.textContent = e),
          (this.currentPageInput.style.width = `${t.offsetWidth + 2}px`),
          ...
          var l = new CustomEvent("r3d-pagechange", {
    ...
    async initJpg() {
      ...
      let t = e.pages || [];
      if (
        (e.previewPages && (t = t.slice(0, e.previewPages)),
        e.pageRangeStart || e.pageRangeEnd)
      ) {
        const i = Math.max((e.pageRangeStart || 1) - 1, 0),
          o = Math.min(e.pageRangeEnd || t.length, t.length);
        t = t.slice(i, o);
      }
      e.pages = t;
      const i = t.length,
        o = (t) => new Promise((i) => this.loadPage(t, e.pageTextureSize, i));
      (e.hasHtmlContent || t.some((e) => e.json) || (e.btnSearch.enabled = !1),
        e.tableOfContent.length ||
          t.some((e) => e.title) ||
          (e.btnToc.enabled = !1));
      const s = ({ width: e, height: t, img: i }) => [
        e || i.width,
        t || i.height,
      ];
      ...
      await o(1);
      const [r, l] = s(t[1]);
      Object.assign(e, { pageWidth2: r, pageHeight2: l });
      const h = n / a;
      if (
        ((e.doublePage = e.scaleCover || r / l / h > 1.5),
        e.doublePage || (e.backCover = i % 2 == 0),
        i > 2 && e.doublePage)
      ) {
        await o(i - 1);
        const [n, a] = s(t[i - 1]);
        e.backCover = r / l / (n / a) > 1.5;
      }
      ((e.doublePage || i % 2 == 1) && (e.cover = !0), this.start());
    }
    async initPdf() {
      this.started ||
        ...
        window.CanvasPixelArray &&
          (window.CanvasPixelArray.prototype.set = function (e) {
            for (var t = this.length, i = 0; i < t; i++) this[i] = e[i];
          }),
    ...
    initPageHTML(e) {
      ...
      t.htmlInitialized ||
        (this.addPageLinks(t),
        this.addPageNotes(t),
        this.addMediaListeners(t),
        (t.htmlInitialized = !0));
    }
    addMediaListeners(e) {
      if (e.htmlContent && e.htmlContent instanceof Element) {
        const t = e.htmlContent.querySelectorAll("video, audio, iframe");
        ((this.mediaElements = this.mediaElements || []),
          this.mediaElements.push(...t));
      }
    }
    addPageLinks(e) {}
    pauseGlobalSound() {
    ...
    addPageNames() {
      ...
      this.options.pages.forEach(function (t, i) {
        void 0 === t.name &&
          ((t.name = i - e + 1),
          t.name < 1 &&
            (t.name = (function (e) {
              ...
              return (
                [
                  ...
                  for (; e >= i.value; ) ((t += i.numeral), (e -= i.value));
                }),
                t
              );
            })(i + 1)));
    ...
    async loadPageHTML(e, t) {
      var i = this.options;
      e < 0
        ? t.call(this, {})
        : i.pdfMode
          ? i.pages[e]
            ? (this.initPageHTML(e), t.call(this, i.pages[e].htmlContent, e))
            : t.call(this, {})
          : (this.initPageHTML(e), t.call(this, i.pages[e].htmlContent, e));
    }
    async fetchAndCacheImage(e) {
      ...
      try {
        const t = (async () => {
          ...
          const i = await t.blob(),
            { bitmapResizeHeight: o, bitmapResizeQuality: s } =
              this.options ?? {},
            n = {};
          return (
            o && (n.resizeHeight = o),
        ...
        return (this.imageCache.set(e, t), await t);
      } catch (t) {
        throw (this.imageCache.delete(e), t);
      }
    }
    loadPage(e, t, i) {
      var o = this,
      ...
      if (n)
        if (this.options.pdfMode && !s) this.loadPageFromPdf(e, t, i);
        else if (t == this.options.thumbTextureSize && n.thumb)
          if (!n.thumbImg && n.thumb) {
            if (
              ((n.thumbImg = new Image()),
              (n.thumbImg.decoding = "async"),
              n.thumbImg.setAttribute("data-id", e),
              (n.thumbImg.onload = function () {
                ((n.thumbLoaded = !0),
                  o.pageLoaded({ index: e, size: t, image: n.thumbImg }, i));
              }),
              "webgl" == this.options.viewMode &&
                (n.thumbImg.crossOrigin = "Anonymous"),
              !1 !== o.options.matchProtocol)
            ) {
              const e = location.protocol;
              n.thumb.startsWith(e) ||
                (n.thumb = n.thumb.replace(/^https?:/, e));
            }
            n.thumbImg.src = n.thumb;
          } else
            n.thumbLoaded
              ? o.pageLoaded({ index: e, size: t, image: n.thumb }, i)
              : setTimeout(function () {
                  o.loadPage(e, t, i);
                }, 300);
        else if (!n.img && n.src) {
          if (!1 !== o.options.matchProtocol) {
            const e = location.protocol;
            n.src.startsWith(e) || (n.src = n.src.replace(/^https?:/, e));
          }
          "webgl" == o.options.viewMode
            ? o.fetchAndCacheImage(n.src).then((s) => {
                ((n.imgLoaded = !0),
                  (n.width = s.width),
                  (n.height = s.height),
                  o.pageLoaded({ index: e, size: t, imageBitmap: s }, i));
              })
            : ((n.img = new Image()),
              ...
              (n.img.onload = function () {
                ((n.imgLoaded = !0),
                  o.pageLoaded({ index: e, size: t, image: n.img }, i));
              }),
              (n.img.src = n.src));
        } else
          n.imgLoaded
    ...
    loadPageFromPdf(e, t, i) {
      ((t = t || this.options.pageTextureSize),
        this.pdfService.renderBookPage(e, t, i));
    }
    getString(e) {
      return this.options.strings[e];
    }
    async mark(e) {
      (await this.loadScript(FLIPBOOK.markSrc, "Mark"), (this.markedStr = e));
      var t = this.wrapper.querySelectorAll(".textLayer"),
        i = Array.from(t).filter(function (t) {
          var i = t.getAttribute("data-marked");
                ...
                className: "mark-blue mark-search",
                  ...
                  i.forEach(function (t) {
                    var i = t.getAttribute("data-marked") || "",
                      o = i ? i.split(",") : [];
                    o.includes(e) ||
                      (o.push(e), t.setAttribute("data-marked", o.join(",")));
                  });
                },
              });
            },
    ...
    unmark() {
      ((this.searchingString = null),
        ...
        this.markInstances.length &&
          (this.markInstances.forEach(function (e) {
            e.unmark({
              className: "mark-search",
              done: function () {
    ...
    toggleIcon(e, t) {
      if (e)
        if (e.$iconAlt)
          t
            ? (e.$iconAlt.classList.add("flipbook-hidden"),
              e.$icon.classList.remove("flipbook-hidden"))
            : (e.$iconAlt.classList.remove("flipbook-hidden"),
              e.$icon.classList.add("flipbook-hidden"));
        else {
          var i = t ? e.iconAlt : e.icon,
            o = t ? e.icon : e.iconAlt;
          e.find("." + i)
            .removeClass(i)
            .addClass(o);
        }
    ...
    scrollPageIntoView(e) {
      let t = e.pageNumber;
      (this.options.doublePage && (t = 2 * t - 1), this.goToPage(t));
    }
    loadScript(e, t) {
      (-1 === e.indexOf("?ver") && (e += `?ver=${FLIPBOOK.version}`),
        (FLIPBOOK.scripts = FLIPBOOK.scripts || {}));
      return new Promise((i, o) => {
        if (t && void 0 !== t.split(".").reduce((e, t) => e && e[t], window))
          return i();
        const s = FLIPBOOK.scripts[e];
        if (s)
          return s.loaded
            ? i()
            : void s.promises.push({ resolve: i, reject: o });
        FLIPBOOK.scripts[e] = {
          loaded: !1,
          promises: [{ resolve: i, reject: o }],
        };
          ...
          (n.onload = n.onreadystatechange =
            function (t, i) {
              i ||
                ...
                (FLIPBOOK.scripts[e].loaded = !0),
                FLIPBOOK.scripts[e].promises.forEach((e) => e.resolve()));
            }),
          (n.onerror = (t) => {
            (FLIPBOOK.scripts[e].promises.forEach((e) => e.reject(t)),
              (FLIPBOOK.scripts[e] = void 0));
          }),
      ...
      return document.querySelector(
        ...
        : new Promise((e, t) => {
            ...
            ((i.async = 1),
              ...
              (i.onerror = function () {
                t(new Error("Google Analytics script failed to load"));
              }),
    ...
    async createBook() {
      ...
      if (
        ...
        this.options.pages.forEach((e) => {
          const t = e.htmlContent || "",
            i = document.createElement("div");
          i.className = "flipbook-page-html";
          const o = document.createElement("div");
          ((o.className = "htmlContent"),
            (o.innerHTML = t),
            i.appendChild(o),
            (e.htmlContent = i));
        }),
        ...
        "swipe" == this.options.viewMode
          ...
          : "scroll" == this.options.viewMode
            ...
            : ("2d" != this.options.viewMode && (this.options.viewMode = "3d"),
              (this.Book = new FLIPBOOK.Book3(this.book, this, e)),
              (this.webglMode = !1),
              this.initSound());
      (this.initSwipe(),
        this.initListeners(),
        ...
        !e.cover && e.startPage < 2 && (e.startPage = 2),
        (this.tocCreated = !1),
    ...
    async destroy() {
      (this.pdfService &&
        (this.pdfService.pages &&
          this.pdfService.pages.forEach(function (e) {
            e.renderingTasks &&
              e.renderingTasks.forEach(function (e) {
                e.cancel();
              });
          }),
    ...
    initNotes() {
      ...
      const e = this;
      window.addEventListener("r3d-update-note-visibility", function (t) {
    ...
    addPageCaptions() {
      ...
      for (let t in e) {
        ...
        if (
          ...
          "string" == typeof i.caption && "" != i.caption)
        ) {
          const e = this.createSVGIcon("camera");
          ((i.htmlContent += '<div class="flipbook-page-caption-btn">'),
            (i.htmlContent += e.outerHTML),
            (i.htmlContent += "</div>"));
          const t =
            '<div class="flipbook-page-caption">' + i.caption + "</div>";
          i.htmlContent += t;
        }
      }
    }
    ...
    showCenterExpandButton() {
      if (!this.centerButtonExpand) {
        ...
        e.className = "flipbook-center-btn-expand";
        const t = this.createSVGIcon("expand");
        (e.appendChild(t),
          e.addEventListener("click", () => {
            this.toggleExpand();
          }),
          this.wrapper.appendChild(e),
          (this.centerButtonExpand = e));
      }
      this.centerButtonExpand.classList.remove("flipbook-hidden");
    }
    hideCenterExpandButton() {
      this.centerButtonExpand &&
        this.centerButtonExpand.classList.add("flipbook-hidden");
    }
    toggleMinimalView() {
      this.wrapperW < this.options.minimalViewBreakpoint &&
      !this.lightbox &&
    ...
    resizeContainer() {
      if (
        ...
        var e = this.pageW / this.pageH,
          t = 2 * e;
        let o,
          s = this.elem.getBoundingClientRect().width;
        o =
          this.options.isMobile && s < this.options.responsiveViewTreshold
            ? e
            : t;
        var i = s / (this.options.containerRatio || o);
        this.elemH != i &&
          ((this.elemH = i), (this.elem.style.height = i + "px"));
      }
      this.resize();
    }
    addEventListeners() {
      ((this.handleResize = () => this.resizeContainer()),
        (this.handleKeydown = (e) => {
          if (
            ...
            (this.fullscreenActive ||
              !document.body.classList.contains("flipbook-fullscreen")) &&
            ((this.options.arrowsAlwaysEnabledForNavigation &&
              (37 == e.keyCode || 39 == e.keyCode)) ||
              (!this.options.lightBox &&
                !this.fullscreenActive &&
                (this.options.arrowsDisabledNotFullscreen ||
      ...
      if (
        ...
        e.lightboxCloseOnBack &&
          (window.onpopstate = function () {
            t.Book.enabled &&
              t.lightbox &&
              t.lightbox.lightboxOpened &&
              (window.location.hash || t.lightbox.closeLightbox(!0));
          }),
        "scroll" != this.options.viewMode &&
          this.bookLayer.addEventListener(
            "wheel",
            function (e) {
              if ((e.ctrlKey && e.preventDefault(), !this.Book.enabled)) return;
              if (
                !this.options.lightBox &&
                !this.fullscreenActive &&
                !e.ctrlKey &&
                ...
                return;
              const t = e.deltaX || -e.wheelDeltaX || -e.detail,
                i = e.deltaY || -e.wheelDeltaY || -e.detail;
              return Math.abs(i) > 0 && Math.abs(i) > Math.abs(t)
                ? (i > 0 ? this.zoomOut(e) : this.zoomIn(e), !1)
                : void 0;
            }.bind(this),
            { passive: !1 },
          ),
        ...
        this.toggleToc(!0);
      else if (t.options.thumbnailsOnStart)
        ...
        const e = this.thumbs.findInput;
        e.value = this.options.searchOnStart;
        const t = new KeyboardEvent("keyup", { bubbles: !0 });
        e.dispatchEvent(t);
      }
      (e.autoplayOnStart && this.toggleAutoplay(!0),
        this.resize(),
    ...
    initSound() {
      if (this.options.flipSound) {
        ...
        ((e.src = this.options.assets.flipMp3),
          (e.type = "audio/mpeg"),
          this.flipSound.appendChild(e));
      }
      if (this.options.backgroundMusic) {
        let e = null;
        if (
          ("string" == typeof this.options.backgroundMusic
            ? (e = this.options.backgroundMusic)
            : this.options.assets &&
          ...
          ((t.src = e),
            (t.type = "audio/mpeg"),
            this.backgroundMusic.appendChild(t),
    ...
    touchSwipe(e, t) {
      ...
      function u(e, t) {
        return { distanceX: e - i, distanceY: t - o };
      }
      function g(e) {
      ...
      function f(e) {
        ...
        if (((n = i.clientX), (a = i.clientY), l && "mousemove" === e.type))
          (e.preventDefault(), t(e, "move", o, s, 0, 1));
        else if (e.touches && 2 === e.touches.length) {
          let i;
          if ((e.preventDefault(), "number" == typeof e.scale)) i = e.scale;
          else {
            let t = p(e.touches);
            h ? (i = t / r) : ((h = !0), (r = t), (i = 1));
          }
          h
            ? t(e, "pinch", i, null, 0, 2)
            : ((h = !0), (r = p(e.touches)), t(e, "pinchstart", i, null, 0, 2));
        } else
          e.touches &&
            1 === e.touches.length &&
            (m.zoom > 1 && e.preventDefault(), t(e, "move", o, s, 0, 1));
      }
      function v(e) {
        (m.trigger("enableIScroll"),
        ...
        let i = e.changedTouches ? e.changedTouches[0] : e,
          { distanceX: o, distanceY: n } = u(i.clientX, i.clientY),
          a = new Date().getTime() - s;
        (l &&
          ((l = !1),
          t(e, "end", o, n, a, e.changedTouches ? e.changedTouches.length : 1)),
      ...
      function k(e) {
        ...
        (l && ((l = !1), t(e, "cancel", o, r, i, 1)),
          h && ((h = !1), t(e, "pinchcancel", o, r, i, 2)),
          w());
      }
      function w() {
    ...
    initSwipe() {
      ...
      (this.touchSwipe(this.book, function (s, n, a, r, l, h) {
        if (
          ((o = "toolSelect" == e.tool || e.options.pageDragDisabled),
          "start" == n)
        ) {
          e.zoomStart = e.zoom;
          try {
            e.currentPageInput.dispatchEvent(
              new Event("blur", { bubbles: !0, cancelable: !0 }),
            );
          } catch (s) {}
          const t = s.target.closest(".flipbook-page-html");
          t && t.classList.add("mousedown");
        }
        if (h > 1 && "pinch" == n) {
          let t = a;
          (s.scale && (t = s.scale), e.zoomTo(e.zoomStart * t, 0, s), (i = !0));
        }
        if ("end" == n) {
          if (!e.options.doubleClickZoomDisabled)
            if (!e.clickTimer && s.touches)
              e.clickTimer = setTimeout(function () {
                delete e.clickTimer;
              }, 300);
            else {
              (clearTimeout(e.clickTimer), delete e.clickTimer);
              const t = s.target.closest(".flipbook-page-html");
              if ((t && t.classList.remove("mousedown"), t && !a && !r)) {
                var d = e.options.zoomTime;
                e.zoom >= e.options.zoomMax
                  ? (e.zoomTo(e.options.zoomMin, d, s),
                    t.classList.remove("zoomed"))
                  : (e.zoomTo(e.options.zoomMax, d, s),
                    t.classList.add("zoomed"));
              }
            }
          Math.abs(a) < 5 && l < 200 && (t = !0);
        }
        (t || i || o || e.Book.onSwipe(s, n, a, r, l, h),
          (t = !1),
          "pinchend" == n && (i = !1));
      }),
        (this.swipeEnabled = !0));
    ...
    createSVGIcon(e, t = !1) {
      const i =
        FLIPBOOK?.Main?.icons?.fontawesome?.[e] ?? FLIPBOOK?.Main?.icons?.[e];
      if (!i) return null;
      const [o, s, n] = i,
      ...
      (r.setAttribute("viewBox", `0 0 ${o} ${s}`),
        ...
        t && r.classList.add("flipbook-icon-reverse"));
      const l = document.createElementNS(a, "path");
      return (l.setAttribute("d", n), r.appendChild(l), r);
    }
    createButton(e) {
      var t = this.options,
        i = e.toolsMenu && t.btnTools.enabled,
        o =
          !i &&
          (("top" === e.vAlign && t.menu2Transparent) ||
            ("top" !== e.vAlign && t.menuTransparent)),
        s = e.background || (o ? t.floatingBtnBackground : t.btnBackground),
        n =
          e.backgroundHover ||
          (o ? t.floatingBtnBackgroundHover : t.btnBackgroundHover),
        a = e.color || (o ? t.floatingBtnColor : t.btnColor),
        r = e.colorHover || (o ? t.floatingBtnColorHover : t.btnColorHover),
        l = o ? t.floatingBtnTextShadow : t.btnTextShadow,
        h = e.radius || (o ? t.floatingBtnRadius : t.btnRadius),
        d = e.border || (o ? t.floatingBtnBorder : t.btnBorder),
        c = o ? t.floatingBtnMargin : t.btnMargin,
        p = t.btnPaddingV + 4,
        u = t.btnPaddingH + 4,
        g = document.createElement("span"),
        m = e.size || t.btnSize;
      i && ((s = "none"), (n = "none"));
      const b = e.svg || e.name.replace("btn", "").toLowerCase();
      var f;
      if (
        ((g.$icon = this.createSVGIcon(b, e.iconReverse)),
        g.appendChild(g.$icon),
        e.svgAlt &&
          ((g.$iconAlt = this.createSVGIcon(e.svgAlt, e.iconReverse)),
          g.appendChild(g.$iconAlt),
          g.$iconAlt.classList.add("flipbook-hidden")),
        (function (e) {
          ((e.style.margin = `${c}px`),
            (e.style.padding = `${p}px ${u}px`),
            (e.style.borderRadius = `${h}px`),
            (e.style.boxShadow = t.btnShadow),
            (e.style.border = d),
            (e.style.color = a),
            (e.$icon.style.fill = a),
            e.$iconAlt && (e.$iconAlt.style.fill = a),
            (e.style.background = s),
            (e.style.textShadow = l),
            (e.style.width = `${m}px`),
            (e.style.height = `${m}px`),
            a && e.classList.remove("skin-color"),
            s && e.classList.remove("skin-color-bg"));
        })(g),
        e.onclick &&
        ...
        (r || n) &&
          (g.addEventListener("mouseenter", function () {
            this.classList.contains("disabled") ||
              ...
              g.$iconAlt &&
                ((g.$iconAlt.style.fill = r),
                (g.$iconAlt.style.background = n)));
          }),
          g.addEventListener("mouseleave", function () {
            ((g.$icon.style.fill = a),
              (g.$icon.style.background = s),
              g.$iconAlt &&
                ((g.$iconAlt.style.fill = a),
                (g.$iconAlt.style.background = s)));
          })),
        i)
      ) {
        f = this.toolsMenu;
        var v = document.createElement("span");
        ((v.textContent = e.title),
          v.classList.add("skin-color"),
          g.appendChild(v));
      } else
        f =
          "top" === e.vAlign
            ...
            : t.menuFloating
              ...
              : "left" === e.hAlign
                ...
                : "right" === e.hAlign
                  ...
                  : this.menuBC;
      return (
        g.setAttribute("data-name", e.name),
        g.classList.add(
          "flipbook-menu-btn-wrapper",
          "flipbook-menu-btn",
          "skin-color",
        ),
        (g.style.order = e.order),
        f.appendChild(g),
        i ||
          (g.setAttribute("data-tooltip", e.title),
          g.classList.add("flipbook-has-tooltip")),
        g
      );
    }
    createAndAppendMenu(e, t) {
      const i = document.createElement("div");
      return ((i.className = e), t.appendChild(i), i);
    }
    initArrowButton(e, t) {
      ...
      (e.addEventListener("click", (i) => {
        ...
        i.arrowBackgroundHover &&
          (e.addEventListener("mouseenter", function () {
            this.classList.contains("disabled") ||
              (e.style.background = i.arrowBackgroundHover);
          }),
          e.addEventListener("mouseleave", function () {
            e.style.background = i.arrowBackground;
          })),
        i.arrowColor && e.classList.remove("skin-color"),
        i.arrowBackground && e.classList.remove("skin-color-bg"));
    }
    createMenu() {
      ...
      ((this.menuBottom = document.createElement("div")),
        this.menuBottom.classList.add("flipbook-menuBottom", t),
        e.menuTransparent ||
          "gradient" === e.skin ||
          this.menuBottom.classList.add("flipbook-border"),
        (this.menuBottom.style.background = e.menuBackground),
        (this.menuBottom.style.boxShadow = e.menuShadow),
        (this.menuBottom.style.margin = e.menuMargin + "px"),
        (this.menuBottom.style.padding = e.menuPadding + "px"),
        this.wrapper.appendChild(this.menuBottom),
        e.menuTransparent ||
          e.menuBackground ||
          this.menuBottom.classList.add("skin-color-bg"),
        e.hideMenu && this.menuBottom.classList.add("flipbook-hidden"),
        ...
        (this.menuTop.style.background = e.menu2Background),
        (this.menuTop.style.boxShadow = e.menu2Shadow),
        (this.menuTop.style.margin = e.menu2Margin + "px"),
        (this.menuTop.style.padding = e.menu2Padding + "px"),
        this.wrapper.appendChild(this.menuTop),
        e.menu2Transparent ||
          e.menu2Background ||
          this.menuTop.classList.add("skin-color-bg"),
        "swipe" === e.viewMode && (e.btnSound.enabled = !1),
        e.progressBar.enabled && e.progressBar.vAlign,
        ...
        e.sideNavigationButtons &&
          ...
          (this.btnNext.style.height = e.arrowSize + "px"),
          (this.btnNext.style.fontSize = e.arrowSize + "px"),
          (this.btnNext.style.marginTop = String(-e.arrowSize / 2) + "px"),
          (this.btnNext.style.marginRight = e.arrowMargin + "px"),
          ...
          (this.btnPrev.style.height = e.arrowSize + "px"),
          (this.btnPrev.style.fontSize = e.arrowSize + "px"),
          (this.btnPrev.style.marginTop = String(-e.arrowSize / 2) + "px"),
          (this.btnPrev.style.marginLeft = e.arrowMargin + "px"),
          ...
          e.btnFirst.enabled &&
            ...
            (this.btnFirst.style.height = 0.5 * e.arrowSize + "px"),
            (this.btnFirst.style.fontSize = 0.5 * e.arrowSize + "px"),
            (this.btnFirst.style.marginTop =
              String(e.arrowSize / 2 + e.arrowMargin + 2 * e.arrowPadding) +
              "px"),
            (this.btnFirst.style.marginLeft = e.arrowMargin + "px"),
          ...
          e.btnLast.enabled &&
            ...
            (this.btnLast.style.height = 0.5 * e.arrowSize + "px"),
            (this.btnLast.style.fontSize = 0.5 * e.arrowSize + "px"),
            (this.btnLast.style.marginTop =
              String(e.arrowSize / 2 + e.arrowMargin + 2 * e.arrowPadding) +
              "px"),
            (this.btnLast.style.marginRight = e.arrowMargin + "px"),
        ...
        e.btnDownloadPdf.url || (e.btnDownloadPdf.enabled = !1),
        !e.pdfTextLayer && e.btnSearch && (e.btnSearch.enabled = !1));
      (window.self !== window.top && (e.btnDownloadPages.enabled = !1),
        (e.btnOrder = [
          "currentPage",
          "progressBar",
          "btnZoomOut",
      ...
      for (var n = [], a = 0; a < e.btnOrder.length; a++) {
        var r = e.btnOrder[a],
          l = e[r];
        (e.isMobile && l.hideOnMobile && (l.enabled = !1),
          l.toolsMenu && l.enabled && n.push(l));
      }
      n.length <= 1 && (e.btnTools.enabled = !1);
      for (a = 0; a < e.btnOrder.length; a++) {
        r = e.btnOrder[a];
        (l = e[r]).enabled &&
          ((l.name = r),
          "currentPage" === l.name
            ...
            : "progressBar" === l.name ||
              ...
              this[r].addEventListener("click", function (t) {
                if ("btnDownloadPdf" == this.dataset.name) {
                  if (window.self !== window.top)
                    parent.postMessage(
                      { type: "download", url: e.btnDownloadPdf.url },
                      "*",
                    );
                  else {
                    var i = e.btnDownloadPdf.url,
                  ...
                  o.sendGAEvent({
                    ...
                    url: e.btnDownloadPdf.url || e.pdfUrl,
                    nonInteraction: !0,
                  });
                } else
                  (t.stopPropagation(),
                    t.preventDefault(),
                    o.onButtonClick(this, t));
              })));
      }
      (e.buttons &&
        e.buttons.forEach((e) => {
          o.createButton(e).index(1);
        }),
        this.btnSingle &&
    ...
    handleFsChange() {
      this.Book &&
        ...
        ((document.fullscreenElement ||
          ...
          document.msFullscreenElement) === this.fullscreenElement ||
        this.isFullscreen
    ...
    createLogo() {
      const { options: e, wrapper: t } = this,
        {
          logoImg: i,
          logoCSS: o,
          logoAlignH: s,
      ...
      const d =
          ...
          [
            ...
            .join(";") +
          ";",
        c = (({ zIndex: e = "", opacity: t = "" } = {}) => {
          const o = document.createElement("img");
          return (
            (o.src = i),
            (o.style.cssText =
              d + (e ? `z-index:${e};` : "") + (t ? `opacity:${t};` : "")),
            a &&
              ((o.style.cursor = "pointer"),
              o.addEventListener("click", (e) => {
                (e.preventDefault(),
                  e.stopPropagation(),
                  window.open(a, r || "_blank"));
              })),
            o
          );
        })();
    ...
    zoomTo(e, t, i) {
      if (e == this.zoom) return;
      var o, s;
      if (((this.zoom = e), void 0 === i))
        ((o = this.wrapperW / 2), (s = this.wrapperH / 2));
      else {
      ...
      (this.zoom < n && (this.zoom = n),
        ...
        this.Book.zoomTo(this.zoom, t, o, s),
        this.onZoom(this.zoom));
    }
    zoomOut(e) {
      var t = this.zoom / this.options.zoomStep;
      const i = this.getZoomMin();
      ((t = t < i ? i : t), this.zoomTo(t, this.options.zoomTime, e));
    }
    zoomIn(e) {
      var t = this.zoom * this.options.zoomStep;
      (t > this.options.zoomMax && (t = this.options.zoomMax),
        this.zoomTo(t, this.options.zoomTime, e));
    }
    getZoomMin() {
    ...
    firstPage() {
      const e = this.options.pages.length;
      this.goToPage(this.options.rightToLeft ? e : 1);
    }
    lastPage() {
      const e = this.options.pages.length;
      this.goToPage(this.options.rightToLeft ? 1 : e);
    }
    goToPage(e, t) {
      if (this.Book) {
        var i = this.options;
        ((e =
          i.rightToLeft && i.pages && i.pages.length
            ? i.pages.length - e + 1
            : e),
          (e = i.rightToLeft && !i.backCover ? e + 1 : e),
    ...
    updateBookLayerSize() {
      const e = this.options,
        t =
          this.menuShowing && !e.menu2OverBook && this.menuTop
            ? this.menuTop.offsetHeight
            : 0,
        i =
          this.menuShowing && !e.menuOverBook && this.menuBottom
            ? this.menuBottom.offsetHeight
            : 0,
        o =
          ("3d" == e.viewMode || e.viewMode,
          this.zoom,
          "webgl" == e.viewMode
            ? this.options.lightBox || this.fullscreenActive
              ? Math.max(t, i)
              : e.bookVerticalPadding
            : 0);
      this.bookVerticalPadding = o;
      const s = (!e.menuOverBook && this.menuBottom ? -o + i : -o) + "px",
        n = (!e.menu2OverBook && this.menuTop ? -o + t : -o) + "px",
    ...
    createCurrentPage() {
      ...
      (h.appendChild(d),
        d.addEventListener("submit", function (e) {
          e.preventDefault();
          var o = parseInt(t.currentPageInput.value, 10);
          return (
            (o = Math.min(o, i.pages.length)),
        ...
        this.currentPageInput.addEventListener("focus", function () {
          t.currentPageInput.value = "";
        }),
        this.currentPageInput.addEventListener("blur", function () {
          t.currentPageInput.value = t.currentPageString;
        }),
    ...
    createMenuHeader(e, t, i) {
      var o = document.createElement("div");
      ((o.className = "flipbook-menu-header skin-clor flipbook-font"),
        e.appendChild(o));
      ...
      ((n.className = "flipbook-btn-close skin-color"),
        ...
        n.addEventListener("click", (e) => {
          (e.stopPropagation(), e.preventDefault(), this.closeMenus());
        }));
      var a = this.createSVGIcon("close");
      n.appendChild(a);
    }
    createToc() {
      var e = this.options.tableOfContent;
      ...
      for (i = 0; i < e.length; i++)
        t[i] &&
          t[i].name &&
          e[i].page &&
          (e[i].pageNumberDisplay = t[e[i].page - 1].name);
      ((this.tocScroller = this.buildTOC(e)),
    ...
    buildTOC(e) {
      ...
      return (
        e.forEach((e) => {
          ...
          if (
            (a.classList.add("title-container"), e.items && e.items.length > 0)
          ) {
            const e = document.createElement("span");
            (e.classList.add("expand-icon"),
              (e.innerHTML = o.outerHTML),
          ...
          if (
            ((l.textContent = e.pageNumberDisplay || e.page),
            ...
            n.addEventListener("click", function (i) {
              if (
                (i.stopPropagation(),
                i.preventDefault(),
                t.options.tableOfContentCloseOnClick && t.toggleToc(!1),
                !e.page && e.dest)
              )
                "string" == typeof e.dest
                  ? t.pdfService.pdfDocument
            ...
            const t = this.buildTOC(e.items);
            ((t.style.display = "none"), s.appendChild(t));
          }
          i.appendChild(s);
        }),
        i
      ...
      if (
        ...
        if (
          ...
          (this.options.sideMenuOverMenu ||
            (e.bottom = this.menuBottom.offsetHeight + "px"),
            this.options.sideMenuOverMenu2 ||
              (e.top = this.menuTop.offsetHeight + "px"),
            this.wrapper
              .querySelectorAll(".flipbook-side-menu")
              .forEach(function (t) {
        ...
        (this.adjustZoomLimits(),
          this.Book.onResize(e),
          this.Book.zoomTo(this.options.zoomMin));
      }
    }
    adjustZoomLimits() {
      var e = this.options,
        t = this.wrapperW / this.wrapperH,
      ...
      (e.menuOverBook &&
        e.menu2OverBook &&
        (e.zoomMin = (this.wrapperH - 2 * a - r) / this.wrapperH),
        "scroll" == e.viewMode
          ? (e.zoomMax =
              (((e.zoomSize * e.pageWidth) / e.pageHeight) * 2) / this.wrapperW)
          : e.responsiveView &&
              this.wrapperW <= e.responsiveViewTreshold &&
              t < o &&
              t < e.responsiveViewRatio
            ? (e.zoomMax = (e.zoomSize / this.wrapperH) * (t > i ? 1 : i / t))
            : (e.zoomMax = (e.zoomSize / this.wrapperH) * (t > o ? 1 : o / t)),
        (e.zoomMax = Math.max(e.zoomMax, e.zoomMin)));
    }
    pdfResize() {
      this.Book.onZoom();
    }
    ...
    toggleToc(e) {
      this.tocCreated
        ? (!this.tocShowing || e
            ...
            : (this.tocHolder.classList.add("flipbook-hidden"),
              (this.tocShowing = !1),
              this.tocHolder.querySelectorAll(".expanded").forEach((e) => {
                e.classList.remove("expanded");
              }),
              this.tocHolder
                .querySelectorAll('[data-expanded="true"]')
                .forEach((e) => {
                  ((e.dataset.expanded = "false"), (e.style.display = "none"));
                })),
          this.resize())
        : this.createToc();
    }
    ...
    toggleToolsMenu() {
      ...
      (this.toolsMenu.parentNode ||
        ...
        this.toolsMenu.addEventListener("click", function (e) {
          e.stopPropagation();
        }),
        document.addEventListener("click", function (t) {
          (e.toolsMenuShowing && e.toggleToolsMenu(),
            e.shareMenuShowing && e.toggleShareMenu());
        })),
    ...
    togglePrintMenu() {
      ...
      if (this.printMenu)
        ...
        ((this.printMenu = document.createElement("div")),
          (this.printMenu.className =
            "flipbook-sub-menu flipbook-font flipbook-border"),
          this.wrapper.appendChild(this.printMenu));
        var t = document.createElement("div");
        ((t.className = "flipbook-sub-menu-center"),
          this.printMenu.appendChild(t));
        ...
        ((i.className = "flipbook-sub-menu-content skin-color-bg"),
          ...
          this.createMenuHeader(
            i,
            this.strings.print,
            this.togglePrintMenu.bind(this),
          ));
        ...
        var s = document.createElement("a");
        ((s.innerHTML =
          '<div class="c-l-p skin-color flipbook-btn">' +
        ...
        ((a.innerHTML =
          '<div class="skin-color flipbook-btn">' +
    ...
    toggleShareMenu() {
      ...
      if (!this.shareMenu.parentNode) {
        (this.btnShare.appendChild(this.shareMenu),
          this.shareMenu.addEventListener("click", function (e) {
            e.stopPropagation();
          }),
          document.addEventListener("click", function (t) {
            (e.toolsMenuShowing && e.toggleToolsMenu(),
        ...
        [
          ...
          if (t[s].enabled) {
            ...
            ((n.className = "flipbook-menu-btn-wrapper flipbook-has-tooltip"),
              ...
              n.setAttribute("data-tooltip", t[s].title || t.strings[s]),
              (n.style.width = `${t.btnSize}px`),
              (n.style.height = `${t.btnSize}px`));
            let a = e.createSVGIcon(s);
            (n.appendChild(a),
              e.shareMenu.appendChild(n),
              n.addEventListener("click", function (s) {
                (s.preventDefault(), s.stopPropagation());
                var a = this.dataset.network;
                if ("copyLink" == a) {
                  var r = t.shareUrl || window.location.href;
                  try {
                  ...
                  function c(e) {
                    ...
                    try {
                      (document.execCommand("copy"),
                        n.setAttribute("data-tooltip", t.strings.copied),
                        setTimeout(() => {
                          n.setAttribute("data-tooltip", t.strings.copyLink);
                        }, 2e3));
                    } catch (e) {
                      console.error("Fallback: Unable to copy text", e);
                    }
                  ...
                  (navigator.clipboard && navigator.clipboard.writeText
                    ? navigator.clipboard
                        ...
                        .catch((e) => {
                          console.error("Failed to copy the link: ", e);
                        })
                    : c(r),
                    e.sendGAEvent({
                  ...
                  var l,
                    ...
                    d = encodeURIComponent(t.shareUrl || window.location.href);
                  encodeURIComponent(t.shareImage || "");
                  switch (a) {
                    case "facebook":
                      l =
      ...
      this.shareMenuShowing
        ...
        : (this.closeMenus(),
          ...
          setTimeout(function () {
            e.shareMenu.style.right = "0";
            const t = e.wrapper.getBoundingClientRect(),
              i = e.shareMenu.getBoundingClientRect();
            i.left < t.left &&
              (e.shareMenu.style.right =
                i.left - t.left - (t.width - i.width) / 2 + "px");
          }, 0));
    }
    toggleNotesMenu() {}
    updateNoteSettings(e) {
    ...
    async bitmapToBlobUrl(e) {
      ...
      t.getContext("2d").drawImage(e, 0, 0);
      const i = await new Promise((e) => t.toBlob(e, "image/png"));
      if (e.close)
        try {
          e.close();
        } catch (e) {}
      return ((t.width = t.height = 1), URL.createObjectURL(i));
    }
    async urlToBlobUrl(e) {
      const t = await fetch(e, { mode: "cors" }),
        i = await t.blob();
      return URL.createObjectURL(i);
    }
    async printPage(e, t) {
      const i = this.options.pages[e],
      ...
      if (i.print) s = i.print;
        ...
        const e = i.imageBitmap[o],
          t = await this.bitmapToBlobUrl(e);
        (n.push(t), (s = t));
      }
      if (s)
        return (
      ...
      const a = this.options.cover ? e : e + 1;
      this.loadPage(a, o, () => {
        this.printPage(e);
      });
    }
    ...
    printFile(e) {
      if (window.self !== window.top)
        parent.postMessage({ type: "print", url: e }, "*");
      else
        try {
    ...
    togglePrintWindow(e) {
      if (window.self !== window.top && e)
        ...
        if (e) i = e;
          ...
          if (t.options.printPdfUrl)
            return void t.printFile(t.options.printPdfUrl);
          if (t.options.pdfUrl) return void t.printFile(t.options.pdfUrl);
        }
        !(function () {
          var o = window.open("about:blank", "_new");
          if ((o.document.open(), e)) i = '<img src="' + e + '"/>\n';
          else
            for (var s = 0; s < t.options.pages.length; s++)
              t.options.pages[s].src &&
                (i +=
                  '<img src="' + t.options.pages[s].src.toString() + '"/>\n');
          var n = (function (e) {
            return (
      ...
      for (const i of t)
        if (e[i])
          try {
            ...
            return void this.handleFullscreenError(e);
          }
      this.handleFullscreenError(
        new Error("Fullscreen API is not supported on this element."),
      );
    }
    exitFullscreen() {
      const e = [
    ...
    handleFullscreenError(e) {
      ...
      (window.self !== window.top
        ? parent.postMessage(
            { type: "toggleExpand", fullscreenActive: this.fullscreenActive },
            "*",
          )
        : this.fullscreenActive
          ? t !== document.body &&
            ...
            t.classList.add("flipbook-browser-fullscreen"),
            (this.elemParent = t.parentNode),
            document.body.appendChild(t))
          : this.elemParent &&
            (this.elemParent.appendChild(t),
            (this.elemParent = null),
            document.body.classList.remove("flipbook-overflow-hidden"),
            t.classList.remove("flipbook-browser-fullscreen"),
            this.restoreScrollPosition()),
        this.toggleIcon(this.btnExpand, !this.fullscreenActive));
    }
    saveScrollPosition() {
      ((document.body.dataset.flipbookScrollX =
        window.scrollX || window.pageXOffset),
        (document.body.dataset.flipbookScrollY =
          window.scrollY || window.pageYOffset));
    }
    restoreScrollPosition() {
      const e = parseInt(document.body.dataset.flipbookScrollX || 0, 10),
        t = parseInt(document.body.dataset.flipbookScrollY || 0, 10);
      isNaN(e) ||
        isNaN(t) ||
        (window.scrollTo(e, t),
  ...
  (FLIPBOOK.Book = class {
    ...
    canFlipPrev() {
      const e = this.options.cover ? 0 : 1;
      return (
        this.flippedleft > e &&
    ...
    async startPageItems(e) {
      if (!e) return;
      const t = e.querySelectorAll(".flipbook-page-item"),
        i = e.querySelectorAll(".flipbook-page-item-youtube");
      e.dataset.pageItemsStarted
        ? t.forEach((e) => {
            if (
              (("VIDEO" !== e.nodeName && "AUDIO" !== e.nodeName) ||
                (e.autoplay &&
                  (e.dataset.autoplayResume || (e.currentTime = 0),
                  e.play().catch(() => {}))),
              e.player && "true" === e.dataset.autoplayResume)
            ) {
              const t = () => {
                try {
                  const t = parseFloat(e.dataset.ytCurrentTime) || 0;
                  (e.player.seekTo(t, !0),
                    e.player.playVideo(),
                    "false" === e.dataset.ytMuted && e.player.unMute());
                } catch (e) {
                  console.error("Error resuming video:", e);
                }
              };
              try {
                e.player.addEventListener("onReady", t);
              } catch {}
              const i = setInterval(() => {
                try {
                  "function" == typeof e.player.getPlayerState &&
        ...
        : (t.forEach(function (e) {
            if ("VIDEO" === e.nodeName || "AUDIO" === e.nodeName) {
              ...
              if (!t) return;
              const i =
                e.querySelector("source") || document.createElement("source");
              if (
                ...
                e.autoplay || e.controls)
              ) {
                const t = () => {
                  (e.currentTime >= e.duration && e.duration > 0 && e.load(),
                    e.autoplay && e.play().catch(() => {}));
                };
                e.readyState < 4 ? (e.oncanplay = t) : t();
              }
            }
          }),
          await this.waitForYouTubeAPI(),
          this.initYouTubePlayers(i),
          (e.dataset.pageItemsStarted = "true"));
    }
    waitForYouTubeAPI() {
      return new Promise((e) => {
        if (window.YT && YT.Player) e();
        else {
          const t = setInterval(() => {
    ...
    initYouTubePlayers(e) {
      e.forEach((e) => {
        const t = e.dataset.videoId,
          i = "true" === e.dataset.autoplay,
          o = (e.dataset.autoplayResume, "true" === e.dataset.controls),
          s = "true" === e.dataset.loop,
          n = "true" === e.dataset.muted,
          a = e.playerIframe || document.createElement("div");
        ((a.id = "yt-" + Math.random()),
          (a.className = "r3d-yt-iframe"),
          (this.main.youtubes = this.main.youtubes || []),
          this.main.youtubes.push(e),
          (e.playerIframe = a),
          e.appendChild(a),
          e.player &&
            "function" == typeof e.player.getPlayerState &&
            ...
            onReady: (t) => {
              ...
              ((e.player = o),
                ...
                this.options.backgroundMusic &&
                  (o.playVideo(),
                  1 === o.getPlayerState() && this.pauseGlobalSound()),
                i && o.playVideo());
            },
            onStateChange: (e) => {
    ...
    loadPageAsync(e, t) {
      ...
      (e._sidePromises || (e._sidePromises = {}),
        e._sidePromises[t] || (e._sidePromises[t] = {}));
      const i = this.options,
      ...
      return (
        e._sidePromises[t][u] ||
          (e._sidePromises[t][u] = new Promise((i, o) => {
            !t || g || b
              ? i()
              : e[p[0]](t, u, () => {
                  i();
    ...
    loadHTMLAsync(e, t) {
      return e
        ? (e._sideHTMLPromises || (e._sideHTMLPromises = {}),
          e._sideHTMLPromises[t] ||
            (e._sideHTMLPromises[t] = new Promise((i) => {
              t
                ? e.loadHTML(t, () => {
                    i();
                  })
  ...
  (FLIPBOOK.Notes = class {
    ...
    initPageNotes(e) {
      ...
      (this.notes.forEach(function (i) {
        i.page == e.index + 1 && t.addPageNote(i, e);
      }),
    ...
    showNote(e, t, i) {
      const o = t.htmlContent.getBoundingClientRect(),
        ...
        (e.textLayerDiv.addEventListener("mouseup", function (e) {
          if (!e.target.classList.contains("add-note-btn"))
            if (
              (t.hideNote(),
              t.showButton(),
              (t.selectedText = window.getSelection()),
              t.selectedText.toString())
            ) {
              ((t.selectedTextString = t.selectedText.toString()),
                (t.selectedTextPageNumber = Number(this.dataset.pageNumber)),
                (t.selectedTextRange = t.selectedText.getRangeAt(0)));
              const e = t.selectedTextRange.getBoundingClientRect(),
                i = this.getBoundingClientRect(),
                o = t.main;
              let s = (o.Book.sc * o.wrapperH) / 1e3;
              ((t.textSelectionRect.style.top =
                (e.y / o.zoom - i.y / o.zoom) / s + "px"),
                (t.textSelectionRect.style.left =
                  (e.x / o.zoom - i.x / o.zoom) / s + "px"),
                (t.textSelectionRect.style.width = e.width / o.zoom / s + "px"),
                (t.textSelectionRect.style.height =
                  e.height / o.zoom / s + "px"),
                this.appendChild(t.textSelectionRect));
            } else t.removeTextRect();
        }),
        e.textLayerDiv.addEventListener("mousemove", function (e) {
          if (t.selectedTextRange && t.selectedText.toString()) {
            const i = t.textSelectionRect.getBoundingClientRect(),
              o = t.textSelectionRect.firstChild.getBoundingClientRect();
            e.clientX >= i.left &&
            e.clientX <= i.right &&
            e.clientY >= o.top &&
            e.clientY <= i.bottom
  ...
  (FLIPBOOK.Tooltip = class {
    ...
    hide() {
      this.showing &&
        (this.domElement.classList.add("flipbook-hidden"), (this.showing = !1));
    }
    position() {
  ...
  (FLIPBOOK.ProgressBar = class {
    constructor(e = {}) {
      ((this.value = e.value || 0),
        (this.min = e.min || 0),
        (this.max = e.max || 100),
        (this.onChange = e.onChange || function (e) {}),
        (this.colors = e.colors || {}),
        (this.wrapper = e.wrapper || document.body),
        (this.el = null),
        (this._dragging = !1),
        this._render(),
    ...
    _render() {
      const e = document.createElement("div");
      ((e.className = "flipbook-progress-bar"),
        (e.tabIndex = 0),
        this.colors.bg && e.style.setProperty("--progress-bg", this.colors.bg),
        this.colors.fill &&
          e.style.setProperty("--progress-fill", this.colors.fill),
        this.colors.thumb &&
          e.style.setProperty("--progress-thumb", this.colors.thumb),
        this.colors.thumbBorder &&
          e.style.setProperty(
            "--progress-thumb-border",
            this.colors.thumbBorder,
          ),
        ...
        this.wrapper.appendChild(e),
        (this.el = e),
        (this.track = e.querySelector(".progress-track")),
        (this.filled = e.querySelector(".progress-filled")),
        (this.thumb = e.querySelector(".progress-thumb")));
    }
    _bindEvents() {
      (this.thumb.addEventListener("mousedown", this._startDrag.bind(this)),
        ...
        this.thumb.addEventListener("touchstart", this._startDrag.bind(this), {
          passive: !1,
        }),
        this.el.addEventListener("touchstart", this._startDrag.bind(this), {
          passive: !1,
        }),
        window.addEventListener("touchmove", this._onDrag.bind(this), {
          passive: !1,
        }),
        window.addEventListener("touchend", this._endDrag.bind(this)),
        this.thumb.addEventListener("keydown", (e) => {
          let t = (this.max - this.min) / 100 || 1;
          (("ArrowRight" !== e.key && "ArrowUp" !== e.key) ||
            (this.setValue(this.value + t), e.preventDefault()),
    ...
    _onDrag(e) {
      ...
      let o = ((t - i.left) / i.width) * 100,
        s = this.min + (this.max - this.min) * (o / 100);
      this.setValue(s);
    }
    _endDrag() {
      this._dragging &&
        ((this._dragging = !1), (document.body.style.userSelect = ""));
    }
    setValue(e) {
      ((e = Math.max(this.min, Math.min(this.max, e))), (this.value = e));
      let t = ((e - this.min) / (this.max - this.min)) * 100;
      ((this.filled.style.width = t + "%"),
        (this.thumb.style.left = t + "%"),
        this.thumb.setAttribute("aria-valuenow", Math.round(e)),
        this.onChange(e));
    }
    getValue() {
      return this.value;
  ...
  (FLIPBOOK.Thumbnails = class {
    constructor(e) {
      ...
      ((this.main = e),
        ...
        (this.thumbHolder.style[t.sideMenuPosition] = "0"),
      ...
      ((n.innerHTML =
        ...
        (this.findInput.placeholder = `${t.strings.findInDocument}...`),
        ...
        this.clearInput.appendChild(e.createSVGIcon("close")),
        ...
        (this.closeGrid.className =
          "flipbook-thumbs-grid-close skin-color flipbook-menu-btn"),
        this.thumbsWrapper.appendChild(this.closeGrid),
        this.closeGrid.addEventListener("click", (e) => {
          (e.stopPropagation(), e.preventDefault(), this.main.closeMenus());
        }),
        ...
        (this.thumbs = []),
        (this.isOverlayMode = "overlay" === t.thumbsStyle));
      const a = t.thumbSize,
        r = (a * t.pageWidth) / t.pageHeight;
      this.main.wrapper.style.setProperty(
        "--flipbook-thumbs-spread-width",
        2 * r + "px",
      );
      const l = new IntersectionObserver(
        (e) => {
          e.forEach((e) => {
            ...
            const t = e.target;
            ("function" == typeof t.instance.load && t.instance.load(),
              l.unobserve(t));
          });
        },
      ...
      for (let i = 0; i < t.pages.length; i++) {
        const o = new FLIPBOOK.Thumbnail(i, r, a, e, t, this);
    ...
    createSpreads() {
      let e;
      const { pages: t, cover: i, backCover: o } = this.options;
      this.spreads = [];
      const s = t.length - (i ? 1 : 0) - (o ? 1 : 0);
      e = (i ? 1 : 0) + (o ? 1 : 0) + Math.ceil(Math.max(0, s) / 2);
      const n = document.createDocumentFragment();
      for (let t = 0; t < e; t++) {
        const s = document.createElement("div");
        (this.spreads.push(s),
          s.classList.add("flipbook-thumb-spread"),
          i && 0 === t && s.classList.add("flipbook-thumb-spread-cover"),
          o &&
            t === e - 1 &&
            s.classList.add("flipbook-thumb-spread-back-cover"));
        const a = 2 * t,
          r = 2 * t + 1;
    ...
    showSpreads() {
      for (let e = 0; e < this.spreads.length; e++) {
        const t = this.spreads[e];
        t.style.display = "";
        const i = 2 * e,
          o = 2 * e + 1;
        (this.thumbs[i - 1]
          ? t.appendChild(this.thumbs[i - 1])
          : t.appendChild(this.coverSpacer),
          this.thumbs[o - 1]
            ? t.appendChild(this.thumbs[o - 1])
            : t.appendChild(this.backCoverSpacer));
      }
      this.spreadsShowing = !0;
    }
    showSingles() {
      for (let e = 0; e < this.thumbs.length; e++)
        this.thumbsScroller.appendChild(this.thumbs[e]);
      this.hideSpreads();
    }
    hideSpreads() {
      if (this.spreads) {
        for (let e = 0; e < this.spreads.length; e++)
          this.spreads[e].style.display = "none";
        this.spreadsShowing = !1;
      }
    }
    findInPageAsync(e, t, i) {
      return new Promise((o) => {
        e.findInPage(t, i, (e, t, i, s) => {
          o({ matches: e, htmlContent: t, index: i, pageText: s });
        });
      });
    }
    searchString(e) {
        ...
        (this.searchTimeout = setTimeout(async () => {
          ...
          if ("" !== e) {
            ...
            if (
              ...
              for (
                let n = 0;
                n < i.info.numPages && e === t.searchingString;
                n++
              ) {
                const {
                  matches: a,
                  index: r,
                  pageText: l,
                } = await this.findInPageAsync(i, e, n);
                if (a && a.length > 0) {
            ...
            (this.hideAllThumbs(),
              this.clearSearchResults(),
              this.main.unmark(),
              (this.main.searchingString = e),
              this.clearInput.classList.add("flipbook-hidden"));
        })));
    }
    getThumbIndexForPage(e) {
      return e;
    }
    loadVisibleThumbs() {}
    getThumbFromPdf(e, t, i) {
      const o = document.createElement("canvas");
      return (
        this.main.pdfService.pdfDocument.getPage(e).then((e) => {
          const s = e.getViewport({ scale: 1 }),
    ...
    showAllThumbs() {
      for (let e = 0; e < this.thumbs.length; e++)
        this.thumbs[e].classList.remove("flipbook-hidden");
      (this.isOverlayMode && this.showSpreads(), this.clearSearchResults());
    }
    hideAllThumbs() {
      for (let e = 0; e < this.thumbs.length; e++)
        this.thumbs[e].classList.add("flipbook-hidden");
    }
    clearSearchResults() {
      const e = this.thumbsScroller.querySelectorAll(".flipbook-search-match");
      for (let t = 0; t < e.length; t++) e[t].remove();
    }
    showSearchResults(e, t, i, o) {
      ...
      if (r && t > 0) {
        d = 2 * t - 1;
        const e = d + 1;
        h = e < c ? `${d + 1}-${e + 1}` : String(d + 1);
      } else h = String(t + 1);
      const p = document.createElement("div");
      ((p.className = "flipbook-search-match"),
        (p.dataset.page = d + 1),
        (p.style.order = d));
      const u = 1 === e ? l.match : l.matches;
      ((p.innerHTML = `\n        <div class="flipbook-search-match-title">\n            <span style="float:left"><strong>${l.page} ${h}</strong></span>\n            <span style="float:right">${e} ${u}</span>\n        </div>\n        <div class="flipbook-search-match-text">${i}</div>\n    `),
        p.addEventListener("click", (e) => {
          (e.stopPropagation(), e.preventDefault());
          const t = Number(p.dataset.page);
          s.goToPage(t);
        }),
        o &&
          (s.goToPage(d + 1, !0),
    ...
    showThumb(e) {
      ...
      t && t.classList.remove("flipbook-hidden");
    }
    hideThumb(e) {
      const t = this.thumbs[e];
      t && t.classList.add("flipbook-hidden");
    }
    showeCloseButtons(e = !0) {
      const t = e ? "remove" : "add";
      for (let e = 0; e < this.thumbs.length; e++) {
        const i = this.thumbs[e].querySelector(".thumb-btn-close");
        i && i.classList[t]("flipbook-hidden");
      }
    }
    showBookmarks() {
    ...
    showBookmarkedThumbs() {
      const e = this.main.getBookmarkedPages();
      (this.hideAllThumbs(), this.showSingles());
      for (let t = 0; t < e.length; t++) {
        const i = e[t];
        if (i) {
          const e = this.getThumbIndexForPage(i);
          this.showThumb(e);
        }
      }
    }
    ...
    setTitle(e) {
      const t = this.thumbHolder.querySelector(".flipbook-menu-title");
      t && (t.textContent = e);
    }
    updateCurrentPages() {
      ...
      if (!this.thumbsByPage) {
        ...
        for (let e = 0; e < this.thumbs.length; e++) {
          const t = this.thumbs[e],
            i = t.getAttribute("data-pages");
          if (!i) continue;
          const o = i.split(",");
          for (let e = 0; e < o.length; e++) {
            const i = Number(o[e]);
            Number.isFinite(i) && this.thumbsByPage.set(i, t);
          }
        }
      }
      const e = this.prevActive || new Set(),
        t = (this.main?.currentPageValue ?? "").toString().trim();
      if (!t) return;
      const i = new Set(
          t
            .split("-")
        ...
        o = new Set([...e, ...i]);
      for (const e of o) {
        const t = this.thumbsByPage.get(e);
        t && t.classList.toggle("flipbook-thumb-active", i.has(e));
      }
      const s = this.thumbsScroller.querySelector(".flipbook-thumb-active");
      if (s) {
        const e = this.thumbsWrapper,
  ...
  (FLIPBOOK.Thumbnail = class {
    constructor(e, t, i, o, s, n) {
      ...
      const a = document.createElement("div");
      this.el = a;
      const r = e % 2 == 1 ? "left" : "right";
      a.className = "flipbook-thumb flipbook-thumb-" + r;
      const l = s.pages[e];
      (a.setAttribute("data-thumb-index", e),
        (a.style.height = i + "px"),
        (a.style.width = t + "px"));
      ...
      const c = 0 === e;
      let p = d && e === s.pages.length - 1,
        u = !1;
      s.doublePage &&
        ((d = s.backCover),
        (p = d && e === s.pages.length - 1),
        (u = !c && !p));
      let g = !1,
        m = !1,
        b = e + 1;
      (s.doublePage && (b = Math.ceil(e / 2) + 1),
        (g = !c && e % 2 == 1 && !p),
        (m = !c && e % 2 == 0 && !p),
        (this.isLeft = g),
        (this.isRight = m),
      ...
      let v = f.toString();
      s.pages[e] && s.pages[e].name && (v = s.pages[e].name);
      const k = v,
      ...
      ((w.textContent = v),
        ...
        a.addEventListener("click", (e) => {
          let t;
          (e.stopPropagation(), e.preventDefault());
          const i = e.currentTarget.getAttribute("data-pages");
          if (i && -1 !== i.indexOf(",")) {
            const e = i.split(","),
              o = Number(e[0]),
              n = Number(e[1]);
            t = s.rightToLeft ? n : o;
          } else t = Number(i || e.currentTarget.getAttribute("data-page"));
          ((!Number.isFinite(t) || t < 1) && (t = 1),
            o.goToPage(t),
            "search" !== n.active &&
              s.thumbsCloseOnClick &&
              o.toggleThumbs(!1));
        }));
    }
    load() {
      ...
      if (this.pdfMode)
        ...
        ((e.src = this.thumbSrc),
          this.isRight && this.isDouble && (e.style.marginLeft = "-100%"));
      }
      (this.el.appendChild(e), (e.style.height = this.height + "px"));
    }
  }),
  (FLIPBOOK.Lightbox = class {
    constructor(e, t, i) {
      ((this.context = e),
        ...
        Object.assign(this.overlay.style, i.lightboxCSS),
        document.body.appendChild(this.overlay),
        i.lightboxBackground &&
          (this.overlay.style.background = i.lightboxBackground),
        i.lightboxBackgroundColor &&
          (this.overlay.style.background = i.lightboxBackgroundColor),
    ...
    openLightbox() {
      ...
      ((this.lightboxOpened = !0), this.showOverlay());
      const e = new Event("r3d-lightboxopen");
    ...
    showOverlay() {
      ...
      (e.classList.remove("flipbook-hidden"),
        e.classList.add("flipbook-overlay-visible"),
    ...
    hideOverlay() {
      if (!this.overlay || !this.$html) return;
      const e = this.overlay;
      (e.classList.remove("flipbook-overlay-visible"),
        e.addEventListener(
          "transitionend",
          () => {
            e.classList.add("flipbook-hidden");
    ...
    closeLightbox(e) {
      if (!this.lightboxOpened) return;
      ((this.lightboxOpened = !1), this.hideOverlay());
      const t = new Event("r3d-lightboxclose");
      (window.dispatchEvent(t),
        this.context.trigger("lightboxclose"),
        this.context.fullscreenElement.classList.remove(
    ...
    disposeLightbox() {
      ((this.lightboxOpened = !1), this.hideOverlay());
      const e = new Event("r3d-lightboxclose");
      (window.dispatchEvent(e),
        this.context.trigger("lightboxclose"),
        this.context.fullscreenElement.classList.remove(
          "flipbook-browser-fullscreen",
  ...
  (FLIPBOOK.onPageLinkClick = function (e) {
    var t = e.dataset.bookid,
      i = e.dataset.page;
    i && FLIPBOOK.books[t].goToPage(Number(i));
    var o = e.dataset.url;
  ...
  (FLIPBOOK.animate = function (e) {
    let t = performance.now(),
      i = e.from,
      o = e.to,
      s = e.duration,
      n = o - i,
      a = FLIPBOOK.easings[e.easing] || FLIPBOOK.easings.linear,
      r = null,
      l = null,
      h = e.repeat || 1,
      d = e.yoyo || !1,
          ...
          : (c++,
            c < h
              ? (d && (p = !p),
                (t = performance.now()),
                (r = requestAnimationFrame(g)))
              : (e.step && e.step(o), e.complete && e.complete())));
    }
    return (
      u > 0
        ? setTimeout(() => {
            ((t = performance.now()), (r = requestAnimationFrame(g)));
          }, u)
        : (r = requestAnimationFrame(g)),
      {
        pause: function () {
      ...
      if (null != (t = arguments[l]))
        for (i in t)
          if (Object.prototype.hasOwnProperty.call(t, i)) {
            if (((o = r[i]), r === (s = t[i]))) continue;
            d && s && (e(s) || (n = Array.isArray(s)))
              ? (n
                  ? ((n = !1), (a = o && Array.isArray(o) ? o : []))
                  : (a = o && e(o) ? o : {}),
  ...
  (FLIPBOOK.Tooltip2 = class {
    ...
    init() {
      ((this.tooltipEl = document.createElement("span")),
        (this.tooltipEl.className =
          "flipbook-tooltip-element skin-color skin-color-bg"),
    ...
    handleMouseOver(e) {
      const t = e.target.closest(".flipbook-has-tooltip");
      t && !t.classList.contains("disabled") && this.showTooltip(t);
    }
    handleFocusIn(e) {
      const t = e.target.closest(".flipbook-has-tooltip");
      t &&
    ...
    handleTouchStart(e) {
      ...
      t &&
        !t.classList.contains("disabled") &&
        (this.showTooltip(t), setTimeout(() => this.hideTooltip(), 2e3));
    }
    handleMouseOut() {
      this.hideTooltip();
    }
    showTooltip(e) {
      ((this.activeTarget = e),
        e.setAttribute("aria-describedby", "flipbook-tooltip"),
        this.observeTooltipChanges(e),
      ...
      let s = t.top - o.top - i.height - 10,
        n = t.left - o.left + (t.width - i.width) / 2,
        a = !1,
        r = t.left - o.left + t.width / 2 - n;
      ((r = Math.max(6, Math.min(i.width - 6, r))),
        s < 0 && ((s = t.bottom - o.top + 10), (a = !0)),
    ...
    observeTooltipChanges(e) {
      (this.tooltipObserver &&
        (this.tooltipObserver.disconnect(), (this.tooltipObserver = null)),
        (this.tooltipObserver = new MutationObserver((t) => {
          if (this.activeTarget && this.activeTarget === e)
            for (const e of t)
              if (
                "attributes" === e.type &&
                "data-tooltip" === e.attributeName
              ) {
                this.updateTooltipText();
                break;
              }
        })),
        this.tooltipObserver.observe(e, {
          attributes: !0,
