...
<body>
    <div class="app login">
        <div class="container-fluid p-h-0 p-v-20 bg full-height d-flex"
            style="background-image: url('{{ asset('manager/assets/images/others/login-3.png')  }}')">
                                    ...
                                    <div class="auth-form" id="login">
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <button class="btn btn-primary form-submit" atr="Login">
                                                    Đăng nhập
                                                </button>
                                            </div>
                                        </div>
    ...
    <script src="{{ asset('manager/assets/js/page/auth.js') }}"></script>
</body>
