            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-form-label control-label">Tên danh mục</label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea name="" id="" class="form-control data-description"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="file" class="form-control image-input" id="image-update" name="image"
