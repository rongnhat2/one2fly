        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <h4 class="m-b-0">Phiếu điều chuyển kho</h4>
                </div>
                <div class="col-sm-12 col-md-6">
            ...
            <div class="m-t-25">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm stock-tranfer-table">
                        <thead>
                            <tr>
                                <th width="20%">
                    ...
                    <div class="form-group text-right">
                        <button class="btn btn-danger mr-2 tab-action" atr="StockTranferTable">Hủy</button>
                        <button class="btn btn-primary create-stock-tranfer">Tạo phiếu</button>
                    </div>
                </div>
            </div>
        </div>
