...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="voucher-group | voucher">
@endsection()
...
<div class="page-header no-gutters has-tab">
    <div class="d-md-flex m-b-15 align-items-center justify-content-between notification relative" id="notification">
        <div class="media align-center justify-content-between m-b-15 w-100">
            <div class="m-l-15">
                <h4 class="m-b-0">Danh sách mã giảm giá</h4>
            </div>
            @include('admin.alert')
        </div>
    </div>
...
@include('admin.manager.voucher.create')
@include('admin.manager.voucher.delete')
