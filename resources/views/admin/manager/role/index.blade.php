...
<div class="page-header no-gutters has-tab">
    <div class="d-md-flex m-b-15 align-items-center justify-content-between notification relative" id="notification">
        <div class="media align-center justify-content-between m-b-15 w-100">
            <div class="m-l-15">
                <h4 class="m-b-0">Danh sách vai trò</h4>
            </div>
            @include('admin.alert')
        </div>
    </div>
...
@include('admin.manager.role.create')
@include('admin.manager.role.delete')
@include('admin.manager.role.assign')
...
<div class="data-custom-tab" data-tab-name="Assign" id="popup-assign"> </div>
...
<script src="{{ asset('manager/assets/js/page/role.js') }}"></script>
