                            ...
                            <div class="image-card-feature-body">
                                <div class="image-card-feature-panel">
                                    ...
                                    <h2 class="image-card-feature-headline">
                                        Du lịch đừng để bị <span class="text-accent font-bold">chặt chém</span>
                                    </h2>
                ...
                <div class="emagazine-spotlight-frame">
                    <div class="grid grid-cols-1 lg:grid-cols-[1.15fr_.85fr]">
                        ...
                        <div class="flex flex-col justify-center px-8 py-10 md:px-12 md:py-14 lg:px-14 lg:py-16 bg-white">
                            ...
                            <a href="#" class="inline-flex items-center gap-2 self-start bg-brand text-white text-[12px] font-semibold uppercase tracking-[0.14em] px-8 py-3.5 rounded-2xl no-underline transition-colors duration-200 hover:bg-brandHover">
                                Xem chi tiết
                    ...
                    <aside class="lg:pt-2 afar-fade-in" data-afar-reveal>
                        ...
                        <div class="border border-line rounded-2xl p-8 bg-canvas">
                            ...
                            <form class="flex flex-col gap-3" action="#" method="post">
                                ...
                                <button type="submit" class="w-full inline-flex items-center justify-center bg-brand text-white px-4 py-3 text-[11px] uppercase tracking-[0.16em] font-semibold rounded-2xl border-0 cursor-pointer transition-colors hover:bg-brandHover">Đăng ký</button>
                            </form>
                        </div>
                    </aside>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div class="order-2">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center gap-5 mt-10">
                            <a href="#" class="inline-flex items-center justify-center bg-brand text-white px-8 py-3.5 text-[11px] uppercase tracking-[0.18em] font-semibold rounded-2xl transition-colors duration-300 hover:bg-brandHover">
                                Read Magazine
                            </a>
                ...
                <div class="max-w-[960px] mx-auto text-center">
                    <div class="bg-white rounded-2xl shadow-soft p-8 md:p-12 grid md:grid-cols-[.9fr_1.1fr] gap-8 items-center text-left">
                        <div>
                            ...
                            <div class="flex gap-3"><a href="{{ route('issue.read') }}" class="bg-brand text-white px-6 py-3 rounded-2xl text-xs uppercase tracking-[.16em] font-semibold hover:bg-brandHover transition-colors">Đọc online</a><a href="{{ route('issue.detail') }}" class="border border-line px-6 py-3 rounded-2xl text-xs uppercase tracking-[.16em] font-semibold text-dark hover:border-brand transition-colors">Chi tiết ấn phẩm</a></div>
                        </div>
