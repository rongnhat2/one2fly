            ...
            return [
                ...
                `<div class="d-flex">
                    ...
                    <div>
                        ...
                        <span class="text-muted font-size-13">Số lượng sản phẩm: ${data.total_products}</span>
                    </div>
                </div>`,
                IndexView.Config.formatPrices(data.total_sold),
                IndexView.Config.formatPrices(data.total_revenue),
